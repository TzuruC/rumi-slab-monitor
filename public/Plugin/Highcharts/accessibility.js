!(
     ...
     */ (function (e, t) {
        'object' == typeof exports && 'object' == typeof module
            ...
            ? define('highcharts/modules/accessibility', ['highcharts/highcharts'], function (e) {
                  return t(
                      e,
                      e.Templating,
                      e.AST,
        ...
        (() => {
            ...
            (x.n = (e) => {
                ...
                (x.d = (e, t) => {
                    for (var i in t)
                        x.o(t, i) && !x.o(e, i) && Object.defineProperty(e, i, { enumerable: !0, get: t[i] });
                }),
            ...
            function M(e) {
                if ('function' == typeof A.MouseEvent) return new A.MouseEvent(e.type, e);
                if (E?.createEvent) {
                ...
                function t(e, t, i) {
                    let s = (e, t) => {
                            let i = e.slice(t || 0),
                                ...
                                n = i.indexOf('}');
                            if (s > -1 && n > s)
                                return { statement: i.substring(s + 1, n), begin: t + s + 1, end: t + n };
                        },
                        n = [],
                        r,
                        o,
                    ...
                    do
                        (r = s(e, a)),
                            (o = e.substring(a, r && r.begin - 1)).length && n.push({ value: o, type: 'constant' }),
            ...
            let K = {
                    ...
                    getChartTitle: function (e) {
                        return R(
                            e.options.title.text || e.langFormat('accessibility.defaultChartTitle', { chart: e }),
                    ...
                    getAxisRangeDescription: function (e) {
                        let t = e.options || {};
                        return t.accessibility && void 0 !== t.accessibility.rangeDescription
                            ...
                            : (function (e) {
                                  let t = e.chart,
                                      ...
                                      s =
                                          (i &&
                                              i.accessibility &&
                                              i.accessibility.screenReaderSection.axisRangeDateFormat) ||
                                          '',
                                      n = { min: e.dataMin || e.min || 0, max: e.dataMax || e.max || 0 },
                                      r = function (i) {
                    ...
                    scrollAxisToPoint: function (e) {
                        ...
                        if (n && L(n.to) && L(n.from)) {
                            ...
                            n.updatePosition(i - t / 2, i + t / 2),
                                z(n, 'changed', { from: n.from, to: n.to, trigger: 'scrollbar', DOMEvent: null });
                        }
                    },
                },
                { doc: G } = w(),
                ...
                V = class {
                    ...
                    removeElement(e) {
                        W(e), this.elements.splice(this.elements.indexOf(e), 1);
                    }
                ...
                Y = class {
                    ...
                    addEvent() {
                        ...
                        return this.eventRemovers.push({ element: arguments[0], remover: e }), e;
                    }
                    removeEvent(e) {
                ...
                es = class extends Z {
                    ...
                    handleSVGTitleElement() {
                        let e = this.chart,
                            ...
                            i = ei(e.langFormat('accessibility.svgContainerTitle', { chartTitle: ee(e) }));
                        if (i.length) {
                            let s = (this.svgTitleElement =
                                this.svgTitleElement || et.createElementNS('http://www.w3.org/2000/svg', 'title'));
                            (s.textContent = i), (s.id = t), e.renderTo.insertBefore(s, e.renderTo.firstChild);
                        }
                    }
                    setSVGContainerLabel() {
                        let e = this.chart,
                            t = e.langFormat('accessibility.svgContainerLabel', { chartTitle: ee(e) });
                        e.renderer.box && t.length && e.renderer.box.setAttribute('aria-label', t);
                    }
                    setGraphicContainerAttrs() {
                        let e = this.chart,
                            t = e.langFormat('accessibility.graphicContainerLabel', { chartTitle: ee(e) });
                        t.length && e.container.setAttribute('aria-label', t);
                    }
                    setRenderToAttrs() {
                        let e = this.chart,
                            t = 'disabled' !== e.options.accessibility.landmarkVerbosity,
                            i = e.langFormat('accessibility.chartContainerLabel', { title: ee(e), chart: e });
                        i &&
            ...
            !(function (e) {
                ...
                function s(e, t) {
                    ...
                    s &&
                        s.focus &&
                        ((s.hcEvents && s.hcEvents.focusin) || en(s, 'focusin', function () {}),
                        s.focus(),
                ...
                function n(e, i) {
                    ...
                    (s.x += this.translateX ? this.translateX : 0), (s.y += this.translateY ? this.translateY : 0);
                    let c = s.x - n,
                        d = s.y - n,
                        u = s.width + 2 * n,
                        p = s.height + 2 * n,
                    ...
                    (this.focusBorder = this.renderer
                        ...
                        (function (e) {
                            ...
                            (e.destroy = function () {
                                return (
                                    e.focusBorder && e.focusBorder.destroy && e.focusBorder.destroy(),
                                    t.apply(e, arguments)
                                );
                            }),
                ...
                e.compose = function (e, t) {
                    let o = e.prototype,
                        a = t.prototype;
                    o.renderFocusBorder || ((o.renderFocusBorder = i), (o.setFocusToElement = s)),
                        a.addFocusBorder || ((a.addFocusBorder = n), (a.removeFocusBorder = r));
                };
            })(p || (p = {}));
            let eo = p;
            var ea = x(660),
            ...
            let { doc: eh } = w(),
                ...
                ep = class {
                    ...
                    createAnnouncerContainer() {
                        ...
                        return (
                            eu(t, { 'aria-hidden': !1, class: 'highcharts-announcer-container' }),
            ...
            function eb(e) {
                return (e.annotations || []).reduce(
                    (e, t) => (t.options && !1 !== t.options.visible && (e = e.concat(t.labels)), e),
                    []
                );
            }
            function ef(e) {
                return (
                    (e.options && e.options.accessibility && e.options.accessibility.description) ||
            ...
            let eL = class extends Z {
                    ...
                    setLinkedDescriptionAttrs() {
                        ...
                        e && (e.setAttribute('aria-hidden', 'true'), eS(e, 'highcharts-linked-description'));
                    }
                    updateScreenReaderSection(e) {
                        ...
                        s
                            ...
                            : (n.parentNode && n.parentNode.removeChild(n), (i.element = null));
                    }
                    setScreenReaderSectionAttribs(e, t) {
                        ...
                        eI(e, { id: `highcharts-screen-reader-region-${t}-${i.index}`, 'aria-label': s || void 0 }),
                            (e.style.position = 'relative'),
                            s &&
                                e.setAttribute(
                                    'role',
                                    'all' === i.options.accessibility.landmarkVerbosity ? 'region' : 'group'
                                );
                    }
                    defaultBeforeChartFormatter() {
                        ...
                        let i = this.getAxesDescription(),
                            ...
                            o = ew(e),
                            a = e.langFormat('accessibility.screenReaderSection.annotations.heading', { chart: e }),
                            l = {
                        ...
                        return (this.dataTableButtonId = r), (this.sonifyButtonId = n), eR(h);
                    }
                        ...
                        return e.types
                            ? e.options.accessibility.typeDescription ||
                                  (function (e, t) {
                                      ...
                                      if (!i) return e.langFormat('accessibility.chartTypes.emptyChart', r);
                                      if ('map' === i || 'tiledwebmap' === i)
                                          return r.mapTitle
                                              ? e.langFormat('accessibility.chartTypes.mapTypeDescription', r)
                                              : e.langFormat('accessibility.chartTypes.unknownMap', r);
                                      if (e.types.length > 1)
                                      ...
                                      return (
                                          (e.langFormat('accessibility.chartTypes.' + o + l, r) ||
                                              e.langFormat('accessibility.chartTypes.default' + l, r)) +
                                          (a ? ' ' + a : '')
                                      );
                                  })(e, e.types)
                            : '';
                    ...
                    getSonifyButtonText(e) {
                        let t = this.chart;
                        return t.options.sonification && !1 === t.options.sonification.enabled
                            ? ''
                            : '<button id="' +
                                  e +
                                  '">' +
                                  t.langFormat('accessibility.sonification.playAsSoundButtonText', {
                                      chart: t,
                                      chartTitle: eT(t),
                                  }) +
                                  '</button>';
                    ...
                    getEndOfChartMarkerText() {
                        ...
                        let t = this.chart,
                            i = t.langFormat('accessibility.screenReaderSection.endOfChartMarker', { chart: t });
                    ...
                    onDataTableCreated(e) {
                        ...
                        if (t.options.accessibility.enabled) {
                            ...
                            (i.tabindex = -1),
                                (i.summary = t.langFormat('accessibility.table.tableSummary', { chart: t })),
                                (e.tree.attributes = i);
                        }
                    }
                    focusDataTable() {
                    ...
                    initSonifyButton(e) {
                        let t = (this.sonifyButton = eP(e)),
                            i = this.chart,
                            s = (e) => {
                                t && (t.setAttribute('aria-hidden', 'true'), t.setAttribute('aria-label', '')),
                                    e.preventDefault(),
                                    e.stopPropagation();
                                ...
                                this.announcer.announce(s),
                                    setTimeout(() => {
                                        t && (t.removeAttribute('aria-hidden'), t.removeAttribute('aria-label')),
                                            i.sonify && i.sonify();
                                    }, 1e3);
                            };
                        t &&
                            ...
                            (t.onclick = function (e) {
                                (
                                    (i.options.accessibility &&
                                        i.options.accessibility.screenReaderSection.onPlayAsSoundClick) ||
                                    s
                                ).call(this, e, i);
                            }));
                    }
                    initDataTableButton(e) {
                        ...
                        t &&
                            ...
                            (t.onclick =
                                i.options.accessibility.screenReaderSection.onViewDataTableClick ||
                                function () {
                    ...
                    getAxesDescription() {
                        let e = this.chart,
                            t = function (t, i) {
                                ...
                                return (
                                    s.length > 1 ||
                                    (s[0] && eF(s[0].options.accessibility && s[0].options.accessibility.enabled, i))
                                );
                            },
                            i =
                                !!e.types &&
                    ...
                    getAxisDescriptionText(e) {
                        let t = this.chart,
                            i = t[e];
                        return t.langFormat(
                            'accessibility.axis.' + e + 'Description' + (i.length > 1 ? 'Plural' : 'Singular'),
                            {
                                chart: t,
            ...
            class eG extends Z {
                ...
                onMenuShown() {
                    ...
                    t && (this.addAccessibleContextMenuAttribs(), eq(e, t)), this.setExportButtonExpandedState('true');
                }
                ...
                proxyMenuButton() {
                    ...
                    (function (e) {
                        ...
                        i &&
                        (this.exportButtonProxy = t.addProxyElement('chartMenu', { click: i }, 'button', {
                ...
                onKbdPrevious(e) {
                    ...
                    return i.keyboardNavigation.wrapAround ? (t.highlightLastExportItem(), s.success) : s.prev;
                }
                onKbdNext(e) {
                    let t = this.chart,
                        i = t.options.accessibility,
                    ...
                    return i.keyboardNavigation.wrapAround ? (t.highlightExportItem(0), s.success) : s.next;
                }
                onKbdClick(e) {
                    let t = this.chart,
                        i =
            ...
            class eQ {
                ...
                updateExitAnchor() {
                    ...
                    this.removeExitAnchor(),
                        e ? (this.makeElementAnExitAnchor(e), (this.exitAnchor = e)) : this.createExitAnchor();
                }
                move(e) {
                ...
                onMouseUp(e) {
                    if ((delete this.isClickingChart, !this.keyboardReset && e.relatedTarget !== e$)) {
                        let t = this.chart;
                        ...
                        t.focusElement && (t.focusElement.removeFocusBorder(), delete t.focusElement),
                ...
                onKeydown(e) {
                    let t,
                        i = e || eX.event,
                        s = this.modules && this.modules.length && this.modules[this.currentModuleIx],
                        n = i.target;
                    if (
                        (!n || 'INPUT' !== n.nodeName || n.classList.contains('highcharts-a11y-proxy-element')) &&
                ...
                updateContainerTabindex() {
                    let e,
                        ...
                        n = this.chart,
                        r = n.container;
                    n.renderTo.hasAttribute('tabindex') ? (r.removeAttribute('tabindex'), (e = n.renderTo)) : (e = r),
            ...
            !(function (e) {
                ...
                e.compose = function (e) {
                    eW.compose(e);
                    let s = e.prototype;
                    return !s.dismissPopupContent && ((s.dismissPopupContent = t), eV && eY(eV, 'keydown', i)), e;
                };
            })(eQ || (eQ = {}));
            let eJ = eQ;
            var e0 = x(632),
            ...
            function tn(e, t) {
                let i = t.legendItem || {};
                for (let s of (t.setState(e ? 'hover' : '', !0), ['group', 'label', 'symbol'])) {
                    let t = i[s],
                        n = (t && t.element) || t;
            ...
            class tr extends Z {
                    ...
                    s.forEach((s) => {
                        if (s.a11yProxyElement) {
                            ...
                            if (((e = s.legendItem || {}), o)) {
                                let t = e.pageIx || 0;
                                l =
                                    (e.y || 0) + (e.label ? Math.round(e.label.getBBox().height) : 0) - i.pages[t] >
                                        r || t !== n - 1;
                            }
                            l
                                ? t.styledMode
                                ...
                                : (ti(a, 'highcharts-a11y-invisible'), (a.style.visibility = ''));
                        }
                    });
                }
                onChartRender() {
                ...
                updateLegendTitle() {
                    let e = this.chart,
                        t = te(
                            ((e.legend && e.legend.options.title && e.legend.options.title.text) || '').replace(
                                /<br ?\/?>/g,
                                ' '
                            ),
                            e.renderer.forExport
                ...
                proxyLegendItem(e) {
                    ...
                    let r = this.chart.langFormat('accessibility.legend.legendItem', {
                        ...
                        o = { tabindex: -1, 'aria-pressed': e.visible, 'aria-label': r, title: '' };
                ...
                getKeyboardNavigation() {
                    ...
                    return new Q(i, {
                        keyCodeMap: [
                            ...
                            [
                                ...
                                function (i) {
                                    ...
                                    return t.highlightAdjacentLegendPage(s), this.response.success;
                                },
                            ],
                        ],
                        validate: function () {
                        ...
                        terminate: function () {
                            (t.highlightedLegendItemIx = -1), i.legend.allItems.forEach((e) => tn(!1, e));
                        },
                    });
                }
                onKbdArrowKey(e, t) {
            ...
            !(function (e) {
                function t(e) {
                    ...
                    if (s) {
                        ...
                        return l && l.element && h && this.setFocusToElement(l, h), tn(!0, s), !0;
                    }
                    return !1;
                }
                function i(e) {
                    ...
                    t.enabled &&
                        i &&
                        i.a11yProxyElement &&
                        i.a11yProxyElement.innerElement.setAttribute('aria-pressed', e.visible ? 'true' : 'false');
                }
                e.compose = function (e, s) {
                    let n = e.prototype;
                    n.highlightLegendItem || ((n.highlightLegendItem = t), e5(s, 'afterColorizeItem', i));
                };
            })(tr || (tr = {}));
            let to = tr;
            var ta = x(532),
            ...
            function tm() {
                ...
                if (n) {
                    ...
                    this.inverted
                        ? ((n.left = n.opposite ? this.chartWidth - r - n.height : this.spacing[3] + r),
            ...
            function tb(e) {
                !this.navigator &&
                    ...
                    ((this.scroller = this.navigator = new d(this)), tu(e.redraw, !0) && this.redraw(e.animation));
            }
            function tf() {
                let e = this.options;
            ...
            function tx() {
                ...
                if (
                    ...
                    ((!th && 'x' === this.zooming.type) || (th && 'x' === this.zooming.pinchType))
                )
                    return !1;
            }
            function ty(e) {
                ...
                if (this.isXAxis && (n?.enabled || a?.enabled)) {
                    if ('y' === l && 'zoom' === e.trigger) t = !1;
                        ...
                        tC(e.min)
                            ...
                            : t && ((e.min = t[0]), (e.max = t[1]), (r.previousZoom = void 0));
                    }
                }
            ...
            class tD {
                static compose(e) {
                    e.keepProps.includes('navigatorAxis') ||
                        (e.keepProps.push('navigatorAxis'), tA(e, 'init', tS), tA(e, 'setExtremes', tP));
                }
                constructor(e) {
                    this.axis = e;
                }
                ...
                tU = {
                    rect: function (e, t, i, s, n) {
                        return n?.r
                            ...
                            : [['M', e, t], ['L', e + i, t], ['L', e + i, t + s], ['L', e, t + s], ['Z']];
                    },
                },
                { relativeLength: tK } = w(),
                tG = {
            ...
            !(function (e) {
                            ...
                            if (t5(r) && t5(o))
                                if (
                                    ((e.horiz && !e.reversed) || (!e.horiz && e.reversed)
                                        ...
                                        : ((s = a + h * (1 - this.from)), (n = a + h * (1 - this.to))),
                ...
                e.compose = function (e, i) {
                    t6(t2, 'Axis.Scrollbar') &&
                        ((t = i), t3(e, 'afterGetOffset', s), t3(e, 'afterInit', n), t3(e, 'afterRender', r));
                };
            })(g || (g = {}));
            let t9 = g,
                t8 = {
            ...
            class ip {
                static compose(e) {
                    t9.compose(e, ip), id(ie, 'Scrollbar') && ia(t7, { scrollbar: t8 });
                }
                static swapXY(e, t) {
                    return (
                        t &&
                            e.forEach((e) => {
                                let t,
                                    i = e.length;
                                for (let s = 0; s < i; s += 2)
                                    'number' == typeof (t = e[s + 1]) && ((e[s + 1] = e[s + 2]), (e[s + 2] = t));
                            }),
                        e
                    );
                }
                ...
                buttonToMaxClick(e) {
                    let t = (this.to - this.from) * ic(this.options.step, 0.2);
                    this.updatePosition(this.from + t, this.to + t),
                        il(this, 'changed', { from: this.from, to: this.to, trigger: 'scrollbar', DOMEvent: e });
                }
                buttonToMinClick(e) {
                    let t = ii(this.to - this.from) * ic(this.options.step, 0.2);
                ...
                destroy() {
                    ...
                    e.removeEvents(),
                        ...
                        t && e === t.scrollbar && ((t.scrollbar = null), io(t.scrollbarButtons));
                }
                drawScrollbarButton(e) {
                    ...
                    if ((i.push(r), s.buttonsEnabled)) {
                        ...
                        this.chart.styledMode ||
                            ...
                            o.attr(
                                o.crisp(
                                    { x: -0.5, y: -0.5, width: n, height: n, r: s.buttonBorderRadius },
                                    o.strokeWidth()
                                )
                            );
                        let a = t
                ...
                position(e, t, i, s) {
                    ...
                    this.group.show(),
                        ...
                        this.scrollbarButtons[1][a]({ translateX: o ? 0 : i - l, translateY: o ? s - h : 0 });
                }
                removeEvents() {
                ...
                render() {
                    ...
                    this.track.attr({ x: -is(0, r), y: -is(0, r) }),
                        (this.scrollbarGroup = e.g().add(n)),
                        (this.scrollbar = e
                            .rect()
                            .addClass('highcharts-scrollbar-thumb')
                            .attr({ height: i - r, width: i - r, r: t.barBorderRadius || 0 })
                        ...
                        s ||
                            ...
                            this.scrollbarRifles.attr({ stroke: t.rifleColor, 'stroke-width': 1 })),
                        (this.scrollbarStrokeWidth = this.scrollbar.strokeWidth()),
                        this.scrollbarGroup.translate(
                            -is(0, this.scrollbarStrokeWidth),
                            -is(0, this.scrollbarStrokeWidth)
                        ),
                ...
                shouldUpdateExtremes(e) {
                    return (
                        ic(this.options.liveRedraw, w().svg && !w().isTouchDevice && !this.chart.boosted) ||
                        'mouseup' === e ||
                        'touchend' === e ||
                        !ir(e)
                    );
                ...
                trackClick(e) {
                    ...
                    (this.options.vertical && t.chartY > s) || (!this.options.vertical && t.chartX > n)
                        ? this.updatePosition(this.from + i, this.to + i)
                        : this.updatePosition(this.from - i, this.to - i),
                        il(this, 'changed', { from: this.from, to: this.to, trigger: 'scrollbar', DOMEvent: e });
                }
                update(e) {
                    this.destroy(), this.init(this.chart.renderer, ih(!0, this.options, e), this.chart);
                }
                updatePosition(e, t) {
                    t > 1 && ((e = ii(1 - ii(t - e))), (t = 1)),
                        e < 0 && ((t = ii(t - e)), (e = 0)),
                        (this.from = e),
                        (this.to = t);
                }
            ...
            class iR {
                static compose(e, t, i) {
                    tw.compose(e, iR), t1.compose(e, t, i);
                }
                constructor(e) {
                ...
                drawMasks(e, t, i, s) {
                    let n,
                        ...
                        c = this.height;
                    i
                        ? ((o = [l, l, l]), (a = [h, h + e, h + t]), (r = [c, c, c]), (n = [e, t - e, this.size - t]))
                        : ((o = [l, l + e, l + t]), (a = [h, h, h]), (r = [e, t - e, this.size - t]), (n = [c, c, c])),
                ...
                renderElements() {
                    let e = this,
                        ...
                        a =
                            e.navigatorGroup ??
                            (e.navigatorGroup = r.g('navigator').attr({ zIndex: 8, visibility: 'hidden' }).add());
                    if (
                        ([!i, i, !i].forEach((i, n) => {
                            let l =
                                e.shades[n] ??
                                (e.shades[n] = r
                                    .rect()
                                    .addClass('highcharts-navigator-mask' + (1 === n ? '-inside' : '-outside'))
                                    .add(a));
                            s.styledMode || (l.attr({ fill: i ? t.maskFill : 'rgba(0,0,0,0)' }), 1 === n && l.css(o));
                        }),
                        e.outline || (e.outline = r.path().addClass('highcharts-navigator-outline').add(a)),
                        s.styledMode || e.outline.attr({ 'stroke-width': t.outlineWidth, stroke: t.outlineColor }),
                        t.handles?.enabled)
                    ) {
                        let i = t.handles,
                            { height: n, width: l } = i;
                ...
                update(e, t = !1) {
                    ...
                    if (
                        (iN(!0, i.options.navigator, e),
                        (this.navigatorOptions = i.options.navigator || {}),
                        this.setOpposite(),
                        iA(e.enabled) || s)
                    )
                        return (
                            this.destroy(), (this.navigatorEnabled = e.enabled || this.navigatorEnabled), this.init(i)
                        );
                    if (
                        ...
                        this.xAxis.update(
                            ...
                            this.yAxis.update({ ...e.yAxis, [i.inverted ? 'width' : 'height']: this.height }, !1);
                    }
                    t && i.redraw();
                }
                render(e, t, i, s) {
                    let n = this.chart,
                        ...
                        x,
                        y;
                    if (this.hasDragged && !iA(i)) return;
                    if (
                            ...
                            (c
                                ? ((b = this.top - p),
                                  (m =
                                      this.left -
                                      f +
                                      (l || !a.opposite ? 0 : (a.titleOffset || 0) + a.axisTitleMargin)),
                                  (f = x + 2 * p))
                                : ((b = this.top + (l ? this.height : -f)), (m = this.left - p)),
                ...
                addMouseEvents() {
                    ...
                    (e.mouseMoveHandler = n =
                        ...
                        (s = e.getPartsEvents('mousedown')).push(
                            iv(t.renderTo, 'mousemove', n),
                            iv(i.ownerDocument, 'mouseup', r),
                            iv(t.renderTo, 'touchmove', n),
                            iv(i.ownerDocument, 'touchend', r)
                        ),
                        ...
                        e.series &&
                            e.series[0] &&
                            s.push(
                                iv(e.series[0].xAxis, 'foundExtremes', function () {
                ...
                shadesMousedown(e, t) {
                    ...
                    i.inverted && ((l = e.chartY), (a = this.top)),
                        1 === t
                            ? ((this.grabbedCenter = l), (this.fixedWidth = o), (this.dragOffset = l - n))
                            : ((u = l - a - o / 2),
                              0 === t
                                  ? (u = Math.max(0, u))
                                  : 2 === t &&
                              ...
                              u !== n &&
                                  ((this.fixedWidth = o),
                                  iA((d = s.navigatorAxis.toFixedRange(u, u + o, c, h)).min) &&
                                      iS(this, 'setRange', {
                ...
                onMouseMove(e) {
                    ...
                    (!e.touches || 0 !== e.touches[0].pageX) &&
                        ...
                        t.hasDragged &&
                            t.scrollbar &&
                            iB(t.scrollbar.options.liveRedraw, !ix && !this.chart.boosted) &&
                            ((e.DOMType = e.type),
                            setTimeout(function () {
                                t.onMouseUp(e);
                            }, 0)));
                ...
                onMouseUp(e) {
                    ...
                    ((this.hasDragged && (!h || !h.hasDragged)) || 'scrollbar' === e.trigger) &&
                        ...
                        iA((o = l.navigatorAxis.toFixedRange(this.zoomedMin, this.zoomedMax, n, r)).min) &&
                            iS(this, 'setRange', {
                                min: Math.min(o.min, o.max),
                                max: Math.max(o.min, o.max),
                                redraw: !0,
                                animation: !this.hasDragged && null,
                                eventArguments: { trigger: 'navigator', triggerOp: 'navigator-drag', DOMEvent: c },
                            })),
                        'mousemove' !== e.DOMType &&
                            'touchmove' !== e.DOMType &&
                            (this.grabbedLeft =
                    ...
                    if (((e.isDirtyBox = !0), h.navigatorEnabled)) {
                        ...
                        (h.xAxis = new (tl())(
                            ...
                            iN(
                                ...
                                e.inverted ? { offsets: t, width: o } : { offsets: t, height: o }
                            ),
                            'xAxis'
                        )),
                            (h.yAxis = new (tl())(
                            ...
                            c || i.series.data
                                ...
                                : 0 === e.series.length &&
                                  (h.unbindRedraw = iv(e, 'beforeRedraw', function () {
                                      e.series.length > 0 && !h.series && (h.setBaseSeries(), h.unbindRedraw());
                                  })),
                            (h.reversedExtremes =
                                (e.inverted && !h.xAxis.reversed) || (!e.inverted && h.xAxis.reversed)),
                            h.renderElements(),
                            h.addMouseEvents();
                    } else
                        (h.xAxis = {
                            ...
                            (h.xAxis.navigatorAxis.toFixedRange = tD.prototype.toFixedRange.bind(
                                h.xAxis.navigatorAxis
                            ));
                    if (e.options.scrollbar?.enabled) {
                        let t = iN(e.options.scrollbar, { vertical: e.inverted });
                ...
                setBaseSeries(e, t) {
                    ...
                    (e =
                        ...
                        (i.series.length ? ik(i.series, (e) => !e.options.isInternal).index : 0)),
                        (i.series || []).forEach((t, i) => {
                            !t.options.isInternal &&
                                (t.options.showInNavigator ||
                                    ((i === e || t.options.id === e) && !1 !== t.options.showInNavigator)) &&
                                s.push(t);
                        }),
                ...
                updateNavigatorSeries(e, t) {
                    let i = this,
                        ...
                        o = (i.series = (i.series || []).filter((e) => {
                            ...
                            return (
                                !(0 > n.indexOf(t)) ||
                                (t && (iI(t, 'updatedData', i.updatedDataHandler), delete t.navigatorSeries),
                                e.chart && e.destroy(),
                                !1)
                            );
                        })),
                    ...
                    n &&
                        ...
                        n.forEach((e) => {
                            let d = e.navigatorSeries,
                                u = iM({ color: e.color, visible: e.visible }, iP(h) ? ib.navigator.series : h);
                            ...
                            (r.name = 'Navigator ' + n.length),
                                ...
                                ((l = iN(a, r, u, c)).pointRange = iB(
                                    u.pointRange,
                                    c.pointRange,
                                    ib.plotOptions[l.type || 'line'].pointRange
                                ));
                            let p = c.data || u.data;
                            ...
                            (h = iF(h)).forEach((e, t) => {
                                (r.name = 'Navigator ' + (o.length + 1)),
                                    ((l = iN(
                                        ...
                                        {
                                            color:
                                                (s.series[t] && !s.series[t].options.isInternal && s.series[t].color) ||
                                                s.options.colors[t] ||
                                                s.options.colors[0],
                                        },
                                        r,
                                    ...
                                    l.data && ((i.hasNavigatorData = !0), o.push(s.initSeries(l)));
                            })),
                ...
                addBaseSeriesEvents() {
                    ...
                    t[0] &&
                        t[0].xAxis &&
                        t[0].eventsToUnbind.push(iv(t[0].xAxis, 'foundExtremes', this.modifyBaseAxisExtremes)),
                        t.forEach((i) => {
                            i.eventsToUnbind.push(
                                ...
                                !1 !== this.navigatorOptions.adaptToUpdatedData &&
                                    i.xAxis &&
                                    i.eventsToUnbind.push(iv(i, 'updatedData', this.updatedDataHandler)),
                                i.eventsToUnbind.push(
                                    iv(i, 'remove', function () {
                                        t && iC(t, i),
                ...
                modifyBaseAxisExtremes() {
                    let e,
                        ...
                        h = i.stickToMin,
                        c = i.stickToMax,
                        d = iB(this.ordinal?.convertOverscroll(this.options.overscroll), 0),
                        ...
                        c &&
                            ...
                            h ||
                                (t = Math.max(
                                    o,
                                    e - l,
                                    i.getBaseSeriesMin(u && u.xData ? u.xData[0] : -Number.MAX_VALUE)
                                ))),
                        p && (h || c) && iD(t) && ((this.min = this.userMin = t), (this.max = this.userMax = e))),
                ...
                addChartEvents() {
                    this.eventsToUnbind || (this.eventsToUnbind = []),
                        this.eventsToUnbind.push(
                            iv(this.chart, 'redraw', function () {
                                let e = this.navigator,
                                    t =
                                        e &&
                                        ((e.baseSeries && e.baseSeries[0] && e.baseSeries[0].xAxis) || this.xAxis[0]);
                                ...
                                this.inverted && (t = e.opposite ? 'marginRight' : 'plotLeft'),
                                    (this[t] =
                                        ...
                                        (e.navigatorEnabled || !this.inverted
                                            ? e.height + (this.scrollbar?.options.margin || 0) + e.scrollbarHeight
                                            : 0) +
                ...
                destroy() {
                    this.removeEvents(),
                        this.xAxis && (iC(this.chart.xAxis, this.xAxis), iC(this.chart.axes, this.xAxis)),
                        this.yAxis && (iC(this.chart.yAxis, this.yAxis), iC(this.chart.axes, this.yAxis)),
            ...
            let { animObject: iL } = w(),
                ...
                iV = class extends Z {
                        ...
                        if (i.enabled && i.accessibility?.enabled) {
                            ...
                            this.proxyProvider.removeGroup('navigator'),
                                this.proxyProvider.addGroup('navigator', 'div', {
                                    ...
                                    'aria-label': iH(s, { chart: e }, e),
                                });
                            let n = t.lang.accessibility?.navigator.handleLabel;
                            [0, 1].forEach((t) => {
                                let i = this.getHandleByIx(t);
                                if (i) {
                                    let s = this.proxyProvider.addProxyElement('navigator', { click: i }, 'input', {
                                        type: 'range',
                                        'aria-label': iH(n, { handleIx: t, chart: e }, e),
                                    });
                    ...
                    getNavigatorHandleNavigation(e) {
                        ...
                        return new Q(i, {
                            ...
                            validate: () =>
                                !!(this.getHandleByIx(e) && s && i.options.navigator.accessibility?.enabled),
                        });
                    }
                    getKeyboardNavigation() {
                                ...
                                ((e) => {
                                    ...
                                    if (i && s && this.minHandleProxy && this.maxHandleProxy) {
                                        ...
                                        [
                                            ...
                                            r && iW(r, iK(t, { x: n.left + i.left + s, y: n.top + i.top }, r));
                                        }),
                                            e && e();
                                        let a = t.options.lang.accessibility?.navigator.changeAnnouncement,
                                            l = iG(t.xAxis[0]);
                                        this.announcer.announce(iH(a, { axisRangeDescription: l, chart: t }, t));
                                    }
                                }).bind(this, e),
                                20
                            ));
                ...
                {
                    getAxisDescription: iY,
                    getSeriesFirstPointElement: ij,
                    getSeriesA11yElement: i_,
                    unhideChartElementFromAT: iZ,
                } = K,
            ...
            function i8(e, t) {
                let i = e[t];
                return e.chart.langFormat('accessibility.series.' + t + 'Description', { name: iY(i), series: e });
            }
            function i7(e) {
                let t = e.series,
                    ...
                    s = (function (e) {
                        let t = e.series,
                            ...
                            r = i5(
                                t.xAxis && t.xAxis.options.accessibility && t.xAxis.options.accessibility.enabled,
                            ...
                            n,
                            {
                                ...
                                value: (function (e) {
                                    let t = e.series,
                                        ...
                                        s =
                                            (t.chart.options.accessibility && t.chart.options.accessibility.point) ||
                                            {},
                                        n = t.tooltipOptions || {},
                                        ...
                                        l = i9(e, e[a]);
                                    if (e.isNull)
                                        return t.chart.langFormat('accessibility.series.nullPointValue', { point: e });
                                    if (t.pointArrayMap) {
                                        let t = r || '',
                                            i = o || '',
                                            s = function (s) {
                    ...
                    o = (function (e) {
                        let t = e.series.chart,
                            i = iX(e);
                        return i.length
                            ? t.langFormat('accessibility.series.pointAnnotationsDescription', {
                                  point: e,
                                  annotations: i,
                              })
                            : '';
            ...
            function se(e) {
                ...
                return i$(
                    i5(
                        e.options.accessibility && e.options.accessibility.descriptionFormat,
                            ...
                            if (
                                ((r || o) &&
                                    e.points.forEach((t) => {
                                                ...
                                                ((function (e) {
                                                    ...
                                                    (function (e) {
                                                        let t = e.series,
                                                            i = (function (e) {
                                                                let t = e.index;
                                                                if (!e.series || !e.series.data || !i4(t)) return null;
                                                                let i = e.series.options?.nullInteraction;
                                                                return (
                                                                    i1(e.series.data, function (e) {
                                                                        return !!(
                                                                            e &&
                                                                            void 0 !== e.index &&
                                                                            (i || e.index > t) &&
                                        ...
                                        if (i) {
                                            if (t.isNull && !a) return void i.setAttribute('aria-hidden', !0);
                                            if (
                                                ...
                                                let e = t.series,
                                                    ...
                                                    r = i0(
                                                        (i3(s.descriptionFormat) &&
                                                            i$(s.descriptionFormat, t, e.chart)) ||
                                                            s.descriptionFormatter?.(t) ||
                                                            (i3(n.descriptionFormat) &&
                                                                i$(n.descriptionFormat, t, e.chart)) ||
                                                            n.descriptionFormatter?.(t) ||
                                                            i7(t),
                                                        e.chart.renderer.forExport
                                                    );
                                                i.setAttribute('role', 'img'), i.setAttribute('aria-label', r);
                                ...
                                t.exposeAsGroupOnly
                                    ...
                                    s.setAttribute(
                                        'aria-label',
                                        i0(
                                            (i.series.descriptionFormatter && i.series.descriptionFormatter(e)) ||
                                                se(e),
                                            e.chart.renderer.forExport
                                        )
                                    );
                    ...
                    if (e.options.accessibility.announceNewData && this.dirty.hasDirty) {
                        ...
                        e &&
                            ...
                            this.queueAnnouncement(
                                Object.keys(this.dirty.allSeries).map((e) => t.dirty.allSeries[e]),
                ...
                queueAnnouncement(e, t, i) {
                    ...
                    if (s.enabled) {
                        let n = +new Date(),
                            ...
                            a = (function (e, t) {
                                let i = (e || []).concat(t || []).reduce((e, t) => ((e[t.name + t.index] = t), e), {});
            ...
            !(function (e) {
                ...
                function i() {
                    ...
                    t &&
                        t.chart === e &&
                        sh(e) &&
                        ((t.dirty.hasDirty = !0), (t.dirty.allSeries[this.name + this.index] = this));
                }
                e.compose = function (e) {
                    sr(si, 'A11y.NDA') && (ss(e, 'addPoint', t), ss(e, 'updatedData', i));
                };
            })(sc || (sc = {}));
            let sd = sc,
                { doc: su, win: sp } = w(),
                ...
                sE = class {
                    ...
                    updateTarget(e, t) {
                        ...
                        sg(this.innerElement, sb(s ? { 'aria-label': s } : {}, i)),
                            this.eventProvider.removeAddedEvents(),
                    ...
                    remove() {
                        this.eventProvider.removeAddedEvents(), sw(this.element);
                    }
                    updateCSSClassName() {
                    ...
                    addProxyEventsToElement(e, t) {
                        [
                            ...
                            this.eventProvider.addEvent(
                                ...
                                (e) => {
                                    let i = s ? sy(e) : sx(e);
                                    t && sf(t, i), e.stopPropagation(), s || e.preventDefault();
                                },
                                { passive: !1 }
                            );
                        });
                ...
                sS = class {
                    ...
                    addProxyElement(e, t, i = 'button', s) {
                        let n = this.groups[e];
                        if (!n) throw Error('ProxyProvider.addProxyElement: Invalid group key ' + e);
                        let r = 'ul' === n.type || 'ol' === n.type ? 'li' : void 0,
                            o = new sE(this.chart, t, i, r, s);
                        return n.proxyContainerElement.appendChild(o.element), n.proxyElements.push(o), o;
                    }
                    addGroup(e, t = 'div', i) {
                        let s,
                            n = this.groups[e];
                        ...
                        return (
                            i && i.role && 'div' !== t
                                ? (s = this.domElementProvider.createElement('div')).appendChild(r)
                                : (s = r),
                            (s.className =
                                'highcharts-a11y-proxy-group highcharts-a11y-proxy-group-' + e.replace(/\W/g, '-')),
                            (this.groups[e] = {
                    ...
                    updateGroupAttrs(e, t) {
                        let i = this.groups[e];
                        if (!i) throw Error('ProxyProvider.updateGroupAttrs: Invalid group key ' + e);
                        sT(i.groupElement, t);
                    }
                    updateGroupOrder(e) {
                        ...
                        ['before', 'after'].forEach((e) => {
                            let t =
                                this['before' === e ? 'beforeChartProxyPosContainer' : 'afterChartProxyPosContainer'];
                            sk(t),
                    ...
                    createProxyPosContainer(e) {
                        ...
                        return (
                            ...
                            sC(t, { top: '0', left: '0' }),
                            this.chart.styledMode || ((t.style.whiteSpace = 'nowrap'), (t.style.position = 'absolute')),
                            t
                        );
                    }
            ...
            class sI extends Z {
                            ...
                            ['minInput', 'maxInput'].forEach(function (s, n) {
                                ...
                                r &&
                                    ...
                                    t.setRangeInputAttrs(
                                        r,
                                        'accessibility.rangeSelector.' + (n ? 'max' : 'min') + 'InputLabel'
                                    ));
                            }));
                }
                updateSelectorVisibility() {
                    ...
                    t && t.hasVisibleDropdown && i
                        ? (sP(e, i), s.forEach((e) => n(e.element)))
                        : (i && n(i), s.forEach((t) => sP(e, t.element)));
                }
                setDropdownAttrs() {
                    let e = this.chart,
                ...
                setRangeButtonAttrs(e) {
                    sB(e.element, { tabindex: -1, role: 'button' });
                }
                setRangeInputAttrs(e, t) {
                    let i = this.chart;
                    sB(e, { tabindex: -1, 'aria-label': i.langFormat(t, { chart: i }) });
                }
                onButtonNavKbdArrowKey(e, t) {
                    ...
                    return n.highlightRangeSelectorButton(n.highlightedRangeSelectorItemIx + o)
                        ? i.success
                        : r
                        ? (e.init(o), i.success)
                        : i[o > 0 ? 'next' : 'prev'];
                ...
                onButtonNavKbdClick(e) {
                    ...
                    return (
                        3 !== i.oldRangeSelectorItemState &&
                            this.fakeClickEvent(i.rangeSelector.buttons[i.highlightedRangeSelectorItemIx].element),
                        t.success
                    );
                }
                onAfterBtnClick() {
                    ...
                    return new Q(e, {
                        ...
                        terminate: function () {
                            i.removeDropdownKeydownHandler &&
                                (i.removeDropdownKeydownHandler(), delete i.removeDropdownKeydownHandler);
                        },
                    });
                }
                    ...
                    return new Q(e, {
                        ...
                        validate: function () {
                            return !!(
                                ...
                                'hidden' !== e.rangeSelector.inputGroup.element.style.visibility &&
            ...
            !(function (e) {
                function t(e) {
                    ...
                    return (
                        void 0 !== i && t[i] && i !== s && t[i].setState(this.oldRangeSelectorItemState || 0),
                        (this.highlightedRangeSelectorItemIx = e),
                        !!t[e] &&
                            (this.setFocusToElement(t[e].box, t[e].element),
                            e !== s && ((this.oldRangeSelectorItemState = t[e].state), t[e].setState(1)),
                            !0)
                    );
                }
                function i() {
                ...
                e.compose = function (e, s) {
                    let n = e.prototype;
                    n.highlightRangeSelectorButton || ((n.highlightRangeSelectorButton = t), sN(s, 'afterBtnClick', i));
                };
            })(sI || (sI = {}));
            let sF = sI,
                { composed: sO } = w(),
            ...
            !(function (e) {
                function t(e) {
                    sL(!0, e, { marker: { enabled: !0, states: { normal: { opacity: 0 } } } });
                }
                function i(e) {
                    ...
                    this.chart.styledMode &&
                        ...
                        s(this) &&
                            this.points.forEach((e) => {
                                e.graphic &&
                                    (e.graphic[e.hasForcedA11yMarker ? 'addClass' : 'removeClass'](
                                        'highcharts-a11y-marker-hidden'
                                    ),
                                    e.graphic[!1 === e.hasForcedA11yMarker ? 'addClass' : 'removeClass'](
                          ...
                          (function (e) {
                              ...
                              if (t) {
                                  ...
                                  e.userOptions && e.userOptions.marker && (e.userOptions.marker.enabled = !0),
                                      e.update({ marker: { enabled: t.enabled, states: { normal: { opacity: i } } } });
                              }
                          })(this),
                          delete this.resetA11yMarkerOptions)
                        : (e.marker && !1 === e.marker.enabled && ((this.a11yMarkersForced = !0), t(this.options)),
                          s(this) &&
                              (function (e) {
                                  ...
                                  for (; s--; ) {
                                      ...
                                      if ((delete r.hasForcedA11yMarker, o.marker)) {
                                          ...
                                          let e = a && 0 === i(o);
                                          o.marker.enabled && !e
                                              ? (sL(!0, (n = o).marker, { states: { normal: { opacity: i(n) || 1 } } }),
                                                (r.hasForcedA11yMarker = !1))
                                              : !1 === o.marker.enabled && (t(o), (r.hasForcedA11yMarker = !0));
                                      }
                                  }
                              })(this));
                }
                function a() {
                    this.boosted &&
                        this.a11yMarkersForced &&
                        (sL(!0, this.options, { marker: { enabled: !1 } }), delete this.a11yMarkersForced);
                }
                e.compose = function (e) {
                    sH(sO, 'A11y.FM') &&
                        (sR(e, 'afterSetOptions', r),
                        sR(e, 'render', o),
                        sR(e, 'afterRender', n),
                        sR(e, 'renderCanvas', a));
                };
            ...
            function sQ(e) {
                ...
                return (
                    ...
                    !e.visible ||
                    (t.pointNavigationEnabledThreshold && +t.pointNavigationEnabledThreshold <= e.points.length)
                );
            }
            function sJ(e) {
                let t = e.series,
                ...
                return (
                    ...
                    ((!(!e.isNull || i) && !1 === e.visible) || !1 === e.isInside || r || sQ(t))
                );
            }
            function s0(e) {
                let t = e.series || [],
                ...
                for (let e = 0; e < i; ++e)
                    if (!sQ(t[e])) {
                        let i = (function (e) {
                            let t = e.points || [],
                                i = t.length;
                            for (let e = 0; e < i; ++e) if (!sJ(t[e])) return t[e];
                            return null;
                        })(t[e]);
                        if (i) return i;
                    }
            ...
            function s1(e) {
                ...
                for (
                    ;
                    t-- &&
                    ((e.highlightedPoint = e.series[t].points[e.series[t].points.length - 1]),
            ...
            class s3 {
                ...
                init() {
                    ...
                    i.addEvent(sG(), 'destroy', function () {
                        ...
                        i.addEvent(t, 'drilldown', function (t) {
                            let i = t.point,
                                s = i.series;
                            e.lastDrilledDownPoint = { x: i.x, y: i.y, seriesName: s ? s.name : '' };
                        }),
                    ...
                    return new Q(i, {
                        keyCodeMap: [
                            ...
                            [
                                [t.end],
                                function () {
                                    return s1(i), this.response.success;
                                },
                            ],
                            [
                                [t.pageDown, t.pageUp],
                                function (e) {
                                    return i.highlightAdjacentSeries(e === t.pageDown), this.response.success;
                                },
                            ],
                        ],
                        init: function () {
                ...
                onHandlerInit(e) {
                    let t = this.chart;
                    return (
                        t.options.accessibility.keyboardNavigation.seriesNavigation.rememberPointFocus &&
                        t.highlightedPoint
                ...
                onKbdVertical(e, t) {
                    ...
                    if (r.mode && 'serialize' === r.mode) return this.attemptHighlightAdjacentPoint(e, n);
                    let o =
                ...
                onSeriesDestroy(e) {
                    ...
                    t.highlightedPoint &&
                        ...
                        (delete t.highlightedPoint, t.focusElement && t.focusElement.removeFocusBorder());
                }
                destroy() {
                    this.eventProvider.removeAddedEvents();
                }
            ...
            !(function (e) {
                function t(e) {
                    ...
                    return sJ(i)
                        ? (sQ((t = i.series))
                              ? (this.highlightedPoint = e ? t.points[t.points.length - 1] : t.points[0])
                        ...
                        ? !!(t = this.series[n.series.index + (e ? -1 : 1)]) &&
                              !!(i = (function (e, t, i, s) {
                                  let n = 1 / 0,
                                      ...
                                      a,
                                      l = t.points.length,
                                      h = (e) => !(sX(e.plotX) && sX(e.plotY));
                                  if (!h(e)) {
                                      for (; l--; )
                                          !h((r = t.points[l])) &&
                                              (a =
                                                  (e.plotX - r.plotX) * (e.plotX - r.plotX) * 4 +
                                                  (e.plotY - r.plotY) * (e.plotY - r.plotY) * 1) < n &&
                                              ((n = a), (o = l));
                ...
                function r() {
                    let e = this.chart.highlightedPoint,
                        ...
                        s = i.length;
                    if (i && s) {
                        for (let e = t; e < s; ++e) if (!sJ(i[e])) return i[e].highlight();
                        for (let e = t; e >= 0; --e) if (!sJ(i[e])) return i[e].highlight();
                    }
                    return !1;
                }
            ...
            let s5 = s3,
                ...
                s9 = class extends Z {
                    static compose(e, t, i) {
                        sd.compose(i), sz.compose(i), s5.compose(e, t, i);
                    }
                    init() {
                    ...
                    onChartRender() {
                        this.chart.series.forEach(function (e) {
                            !1 !== (e.options.accessibility && e.options.accessibility.enabled) &&
                            e.visible &&
                ...
                ni = class extends Z {
                    ...
                    setMapNavButtonAttrs(e, t) {
                        let i = this.chart;
                        ne(e, { tabindex: -1, role: 'button', 'aria-label': i.langFormat(t, { chart: i }) });
                    }
                    onChartRender() {
                        ...
                        if (
                            ...
                            e.resetZoomButton &&
                                this.createZoomProxyButton(
                                    ...
                                    e.langFormat('accessibility.zoom.resetZoomButton', { chart: e })
                                ),
                    ...
                    onMapKbdArrow(e, t) {
                        ...
                        return (
                            [s7('mousedown', h), s7('mousemove', c), s7('mouseup', c)].forEach((e) =>
                                n.dispatchEvent(e)
                            ),
                            e.response.success
                        );
                    ...
                    onMapKbdTab(e, t) {
                        ...
                        if ((i.mapNavigation.navButtons[this.focusedMapNavButtonIx].setState(0), r))
                        ...
                        return i.setFocusToElement(o.box, o.element), o.setState(2), s.success;
                    }
                    onMapKbdClick(e) {
                ...
                no = {
                    isHighContrastModeActive: function () {
                        if (nn && nr.getComputedStyle) {
                            ...
                            return ns.body.removeChild(e), 'none' === t;
                        }
                ...
                na = {
                    ...
                    colorAxis: { minColor: 'windowText', maxColor: 'windowText', stops: [], dataClasses: [] },
                    colors: ['windowText'],
                    xAxis: {
            ...
            function nc(e, t, i) {
                let s = e,
                    n,
                    r = 0;
                for (; r < t.length - 1; ++r) s = s[(n = t[r])] = nh(s[n], {});
                s[t[t.length - 1]] = i;
            }
            function nd(e, t, i, s) {
                function n(e, t) {
                ...
                Object.keys(s).forEach(function (n) {
                    ...
                    void 0 !== a &&
                        (nc(o, s[n], a),
                        nl(32, !1, e, { [t.join('.') + '.' + n]: i.join('.') + '.' + s[n].join('.') }));
                });
            }
            let nu = function (e) {
                    ...
                    ['description', 'typeDescription'].forEach(function (s) {
                        t[s] && ((i[s] = t[s]), nl(32, !1, e, { [`chart.${s}`]: `use accessibility.${s}` }));
                    }),
                        e.axes.forEach(function (t) {
                            ...
                            i &&
                                ...
                                nl(32, !1, e, { 'axis.description': 'use axis.accessibility.description' }));
                        }),
                        e.series &&
                            (function (e) {
                                let t = {
                                ...
                                e.series.forEach(function (i) {
                                    Object.keys(t).forEach(function (s) {
                                        ...
                                        'accessibility.pointDescriptionFormatter' === s &&
                                            ...
                                            void 0 !== n &&
                                                (nc(i.options, t[s], 'skipKeyboardNavigation' === s ? !n : n),
                                                nl(32, !1, e, { [`series.${s}`]: 'series.' + t[s].join('.') }));
                                    });
                                });
                            })(e),
            ...
            class nv {
                ...
                init(e) {
                    if (((this.chart = e), !ng?.addEventListener)) {
                ...
                getComponentOrder() {
                    return this.components
                        ? this.components.series
                            ? ['series'].concat(Object.keys(this.components).filter((e) => 'series' !== e))
                ...
                update() {
                    let e = this.components,
                        t = this.chart,
                        i = t.options.accessibility;
                    nf(t, 'beforeA11yUpdate'), (t.types = this.getChartTypes());
                    let s = i.keyboardNavigation.order;
                    this.proxyProvider.updateGroupOrder(s),
                        this.getComponentOrder().forEach(function (i) {
                            e[i].onChartUpdate(), nf(t, 'afterA11yComponentUpdate', { name: i, component: e[i] });
                        }),
                        this.keyboardNavigation.update(s),
                        !t.highContrastModeActive &&
                            !1 !== i.highContrastMode &&
                            (no.isHighContrastModeActive() || !0 === i.highContrastMode) &&
                            no.setHighContrastTheme(t),
                        nf(t, 'afterA11yUpdate', { accessibility: this });
                }
                destroy() {
                    let e = this.chart || {},
                        t = this.components;
            ...
            !(function (e) {
                ...
                function s(e) {
                    ...
                    t &&
                        (t.customComponents &&
                            ((this.options.accessibility.customComponents = t.customComponents),
                ...
                nx(
                    ...
                    {
                        accessibility: { highContrastTheme: na },
                        lang: {
                            accessibility: {
