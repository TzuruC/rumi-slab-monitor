...
(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        options: {
             ...
             * @default
             */
            tooltipTextFinish: '單擊即可結束繪製</b><br>',
            tooltipTextDelete: '按住 Shift 進行點擊即可刪除該點',
            tooltipTextMove: '按住該點位並拖曳即可移動點位<br>',
            tooltipTextResume: '<br>按住 Ctrl 進行點擊即可修改航線',
             ...
             * @default
             */
            measureControlTitleOn: "開始航線繪製",
            /**
             * Title for the control going to be switched off
             * @type {String}
             * @default
             */
            measureControlTitleOff: "結束航線繪製",
            /**
