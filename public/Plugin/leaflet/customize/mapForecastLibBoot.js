(window.W = Object.assign(window.W || {}, {
    ...
    (function (e) {
        ...
        (e.wError = function (e, t, i) {
            ...
            (e.windySentErrors = t),
            (e.onerror = n.bind(null, 'error'));
    })(window),
    (function (e) {
        var t = {};
        function n(e, n, i, o, r) {
            if (e in t) throw new Error('DI conflict: Module ' + e + ' already defined.');
            t[e] = { name: e, dependencies: n, callback: i, wasLoaded: !1, html: o, css: r };
        }
        function i(n, o) {
            var r = [];
        ...
        _updateTransform: function (e, t) {
            if (this._map && this._canvas && this._center) {
                var n = this._map.getZoomScale(t, this._zoom),
                    ...
                    o = this._map.getSize().multiplyBy(0.5 + (this.options.padding || 0)),
    ...
    W.define('Evented', ['Class'], function (e, t) {
        var n = function () {
            ...
            o = [];
        function r(e, t, n) {
            o.push({ ts: Date.now(), txt: e + ': ' + t + ('string' == typeof n ? ' ' + n : '') }),
                o.length > 5 && o.shift();
        }
        W.latestBcasts = o;
        var a = t.extend({
            ...
            emit: function (e) {
                ...
                n() &&
                    console.log.apply(console, ['%c' + this.ident + ': ' + e, 'color:' + this.terminalColor].concat(i)),
                    r(this.ident || 'eventedModule', e, i[0]);
            ...
            off: function (e, t, n) {
                if ('number' == typeof e)
                    ...
                    if (a) {
                        for (var s = a.length; s--; )
                            a[s].callback !== t || (n && n !== a[s].context) || a.splice(s, 1);
    ...
    W.define(
        'http',
        ['lruCache', 'rootScope', 'utils', 'broadcast', 'device', 'store'],
        function (e, t, n, i, o, r, a) {
            var s = i.joinPath,
                ...
                T = function (e) {
                    return b(e)
                        ? (/^http/.test(e) || (e = s(n.nodeServer, e)), u && (e = l(e, u)), (e = l(e, 'poc=' + ++h)))
                        : e;
                };
            y(!0),
                a.on('userToken', function () {
                    return y(!1);
                });
            var S = function (e) {
                    return {
                ...
                _ = function (e, t, n) {
                    ...
                    var r,
                        s = v.test(t) || g.test(t) || n.withCredentials,
                        u = t;
                    ...
                    if (b(t) && ((t = T(t)), /^\/?forecast\//.test(u))) {
                        ...
                        (t =
                            E +
                            '/' +
                            ('Zm9yZWNhc3Q/' + window.btoa(P).replace(/=/g, '')) +
                            '/' +
                            window.btoa(L).replace(/=/g, '')),
                            (y = !0);
                    }
                            ...
                            w.onreadystatechange = function () {
                                ...
                                if (4 === w.readyState)
                                    if (
                                        ...
                                        var a = { status: w.status, headers: r, data: void 0 };
                                        n.binary
                                            ? (a.data = w.response)
                                            : y
                                            ? ((a.isJSON = !0), (a.data = window.atob(w.responseText)))
                                            : ((a.isJSON =
                                                  n.json || /json/.test(w.getResponseHeader('Content-Type') || '')),
                                              (a.data = w.responseText)),
                                            n.cache && ((a.expire = (n.ttl || 3e5) + Date.now()), d.put(u, a));
                                        var s = S(a);
                                        e(s);
                                    } else
                                        0 === w.status && o.emit('noConnection', 'http'), n.cache && d.remove(u), t(w);
                            };
                        }),
                        O = null;
                    ('post' !== e && 'put' !== e) ||
                        (w.setRequestHeader('Content-type', 'application/json; charset=utf-8'),
                        (O = JSON.stringify(n.data)));
                    try {
                        w.send(O);
                    } catch (e) {
    ...
    W.define('subscription', ['store', 'http', 'broadcast'], function (e, t, n, i) {
        var o = function () {
            ...
            s = function (e, n) {
                return (
                    ...
                    null === e
                        ? a()
                        : (r(), t.remove('failedSubscriptionPayment'), document.body.classList.add('subs-' + e)),
                    t.set('subscription', e),
                    n.reloadUserToken && i.emit('userReloadInfo'),
                    e
                );
            },
            l = function () {
        ...
        var c = {
            ...
            redeem: function (e) {
                return n
                    .post('https://account.windy.com/api/v1/subscription/redeem', {
                        data: { redeemCode: e },
                        withCredentials: !0,
                    })
                    .then(function (e) {
                        var t = e.data;
                        s(t.tier, { reloadUserToken: !0 });
                    })
                    .catch(function (e) {
    ...
    W.define('utils', ['rootScope'], function (e, t) {
        ...
        var o = 'bcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789a',
            ...
            f = function (e, t, n, i, o) {
                return (
                    (0.5 * -e + 3 * t * 0.5 - 3 * n * 0.5 + 0.5 * i) * o * o * o +
                    (e - 5 * t * 0.5 + 2 * n - 0.5 * i) * o * o +
                    (0.5 * -e + 0.5 * n) * o +
                    t
                );
            },
        ...
        (e.$ = function (e, t) {
            ...
            (e.bicubicFiltering = function (e, t, n) {
                return f(
                    f(e[0], e[1], e[2], e[3], t),
                    f(e[4], e[5], e[6], e[7], t),
                    f(e[8], e[9], e[10], e[11], t),
                    f(e[12], e[13], e[14], e[15], t),
                    n
                );
            }),
            (e.bound = u),
            ...
            (e.download = function (e, t, n) {
                var i = document.createElement('a'),
                    o = e instanceof Blob ? e : new Blob([e], { type: t });
                (i.style.display = 'none'),
                    document.body.appendChild(i),
                    window.URL && (i.href = window.URL.createObjectURL(o)),
            ...
            (e.isValidLatLonObj = function (e) {
                return (
                    (e && 'object' == typeof e && 'lat' in e && 'lon' in e && !isNaN(+e.lat) && !isNaN(+e.lon)) || !1
                );
            }),
            ...
            (e.latDegToYUnit = function (e) {
                return h(0.5 - 0.00555555555555555 * e);
            }),
            ...
            (e.spline = function (e, t, n, i, o) {
                return (
                    0.5 *
                    (2 * t + (-e + n) * o + (2 * e - 5 * t + 4 * n - i) * o * o + (3 * t - e - 3 * n + i) * o * o * o)
                );
            }),
            (e.str2latLon = function (e) {
                var t = e.split('a');
                return { lat: s(t[0]) / 100 - 90, lon: s(t[1]) / 100 - 180 };
            }),
    ...
    W.define('urls', ['rootScope', 'utils', 'store', 'subscription', 'products'], function (e, t, n, i, o, r) {
        (e.getCitytile = function (e, t) {
            var i,
                ...
                s,
                l,
                c = 'https://ims-s.windy.com/forecast/citytile/v1.3/' + e + '/' + t,
                d =
                    null === (i = r[e]) || void 0 === i || null === (a = i.calendar) || void 0 === a
                        ? void 0
                        : a.numOfHours;
            return (
                (c = n.addQs(
                    ...
                    'step=' +
                        (!1 ===
                            (null === (s = r[e]) || void 0 === s || null === (l = s.minifest) || void 0 === l
                                ? void 0
                                : l.premium) || o.hasAny()
                            ? 1
                            : 3)
                )),
                d && (c = n.addQs(c, 'hours=' + d)),
                (function (e, t) {
                    var i = r[t];
            ...
            (e.getWebcamsList = function (e) {
                var t = e.lat,
                    o = e.lon;
                return '/webcams/v1.0/list?' + n.qs({ nearby: t + ',' + o, lang: i.get('usedLang') || 'en' });
            });
    }),
            ...
            (e.howOld = function (e) {
                ...
                if ((n < 0 && (t = !0), (n = Math.abs(n)), e && e.translate)) {
                    ...
                    if (n < 60) {
                        ...
                        return i.template(r, { DURATION: n });
                    }
                    if (n < 240) {
                        var a = Math.floor(n / 60),
                            s = n - 60 * a,
                            l = t ? o.METARS_H_M_LATER : o.METARS_H_M_AGO;
                        return i.template(l, { DURATION: a, DURATIONM: s });
                    }
                    if (n < 1440) {
                        var c = t ? o.METAR_HOURS_LATER : o.METAR_HOURS_AGO;
                        return i.template(c, { DURATION: Math.floor(n / 60) });
                    }
                    var d = t ? o.METARS_DAYS_LATER : o.METARS_DAYS_AGO;
                    return i.template(d, { DURATION: Math.floor(n / 1440) });
                }
                return (
                    (e.useAgo && t ? 'in ' : '') +
                    (n < 60 ? Math.floor(n) + 'm' : Math.floor(n / 60) + 'h ' + Math.floor(n % 60) + 'm') +
                    (e.useAgo && !t ? ' ago' : '')
                );
            }),
    ...
    W.define('Calendar', ['format', 'utils', 'trans'], function (e, t, n, i) {
        var o = i.t,
            r = function e(t) {
                ...
                for (var d = 1; d < this.paths.length; d++)
                    this.interTimestamps.push(
                        this.timestamps[d - 1] + Math.floor((this.timestamps[d] - this.timestamps[d - 1]) / 2)
                    );
            };
        (r.prototype.initProperties = function () {
            ...
            (r.prototype.ts2path = function (e) {
                for (var t = this.interTimestamps, n = 0; n < t.length; n++) if (e < t[n]) return this.paths[n];
            ...
            (r.prototype.prepareTimesFromMinifest = function (e) {
                return e && 'object' == typeof e && e.ref && e.dst
                    ? ((this.refTime = e.ref.replace(/(\d+)-(\d+)-(\d+)T(\d+):.*/, '$1$2$3$4')),
                      ...
                      !0)
                    : (window.wError('Calendar', 'Invalid format of minifest'), !1);
            }),
            ...
            (r.localeHours = t.getHoursFunction()),
            (r.weekdays = ['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT']),
            (e.Calendar = r);
    }),
    W.define('Metric', ['store', 'broadcast', 'trans'], function (e, t, n, i) {
        ...
        (a.prototype.onMetricChanged = function (e) {
            ...
            (a.prototype.convertValue = function (e, t) {
                ...
                return void 0 === e
                    ? ''
                    : this.convertNumber(e) +
                          (t || this.separator) +
                          ((null === (n = this.conv[this.metric]) || void 0 === n ? void 0 : n.label) || this.metric);
            }),
            ...
            (a.prototype.setMetric = function (e) {
                ...
                t.set(this.key, e),
                    this.cohesion &&
                        Object.keys(this.cohesion).forEach(function (i) {
                            var o,
                                r,
                                a =
                                    null === (o = n.cohesion) || void 0 === o || null === (r = o[i]) || void 0 === r
                                        ? void 0
                                        : r[e];
            ...
            (a.prototype.renderLegend = function (e, t, n) {
                ...
                if (e.getColor()) {
                    ...
                    (t.dataset.overlay = this.ident),
                        t.classList[this.howManyMetrics() > 1 ? 'remove' : 'add']('one-metric'),
        ...
        var s = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.convertNumber = function (e, t, n) {
            ...
            l = (function (e) {
                ...
                return (
                    ...
                    (t.prototype = Object.create(e && e.prototype)),
                    (t.prototype.constructor = t),
                    (t.prototype.updateLines = function (e) {
                        var t = this,
                            n = {
                                'Â°C': {
                        ...
                        for (
                            var c = function (e) {
                                    ...
                                    (l[e] = u), (t.conv[d] = { conversion: u, precision: 0, na: '' });
                                },
                                d = 0;
                            d < r.length;
                            d++
            ...
            c = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.initProperties = function () {
                        e.prototype.initProperties.call(this),
                            (this.defaults = ['mm', 'in']),
                            (this.nativeSync = !0),
                            (this.description = ['mm', 'in']),
                            (this.cohesion = { snow: { in: 'in', mm: 'cm' } }),
                            (this.conv = {
                                mm: { conversion: r, precision: 1 },
                                in: {
                                    conversion: function (e) {
                                        return 0.0394 * e;
                                    },
            ...
            d = (function (e) {
                ...
                return (
                    ...
                    (t.prototype = Object.create(e && e.prototype)),
                    (t.prototype.constructor = t),
                    (t.prototype.convertNumber = function (e) {
                        var t = {
                            0: 'RAIN',
                            1: 'JUST_RAIN',
                            2: 'THUNDER',
    ...
    W.define('Color', ['store', 'Class'], function (e, t, n) {
        var i = n.extend({
            ...
            defineColor: function (e) {
                t.insert(this.key, { def: e, save: this.save, sync: this.sync, allowed: this.checkValidity }),
                    t.on(this.key, this.colorChanged, this),
            ...
            rgba2yuva: function (e) {
                var t = e[0],
                    n = e[1],
                    i = e[2],
                    o = 0.299 * t + 0.587 * n + 0.114 * i;
                return [o, 0.565 * (i - o), 0.713 * (t - o), e[3]];
            },
            yuva2rgba: function (e) {
                var t = e[0],
                    n = e[1],
                    i = e[2];
                return [t + 1.403 * i, t - 0.344 * n - 0.714 * i, t + 1.77 * n, e[3]];
            },
            ...
            getGradientColorYUVA: function (e, t, n) {
                for (
                    var i = 1 / 255,
                        o = this.getMulArray(e, i),
                        r = this.getMulArray(t, i),
                        a = this.rgba2yuva(o),
                        s = this.rgba2yuva(r),
                    ...
                    c[d] = Math.max(0, Math.min(256 * c[d], 255));
                return c;
            },
            ...
            createGradientArray: function (e, t, n) {
                ...
                for (s = 0; s < this.steps; s++)
                    (o = this.min + d * s * n) > m[0] && p < u.length && ((f = m), (m = u[p++])),
                        (a = (o - f[0]) / (m[0] - f[0])),
                        (r = this.getGradientColorYUVA(f[1], m[1], a)),
                        t && this.makePremultiplied(r),
                        (c[h++] = Math.round(r[0])),
                        (c[h++] = Math.round(r[1])),
                        (c[h++] = Math.round(r[2])),
                        (c[h++] = e ? 255 : Math.round(r[3]));
            ...
            getColor: function () {
                return this.colors
                    ? this
                    : t.hasProperty(this.key)
                    ? ((this.gradient = t.get(this.key)),
                      this.setMinMax(),
    ...
    W.define(
        ...
        function (e, t, n, i, o, r, a, s, l, c, d, u) {
            var h = d.Window,
                p = c.Calendar,
                f = l.extend({
                    ident: 'ecmwf',
                    ...
                    getUpdateTimes: function () {
                        return this.calendar
                            ? { refTime: this.calendar.refTimeTxt, minUpdate: this.calendar.updateTs }
                            : {};
                    },
                    ...
                    moveTs: function (e, n) {
                        if ((void 0 === n && (n = !1), n)) {
                            ...
                            if (i > -1)
                                return (
                                    (i = t.bound(i + (e ? 1 : -1), 0, this.acTimes.length)),
                                    s.set('acTime', this.acTimes[i]),
                                    !0
                                );
                        } else {
                            var o = this.calendar,
                            ...
                            if (l > -1)
                                return (
                                    ...
                                    s.set('timestamp', a[l], { UIident: 'keyboard' }),
                                    !0
                                );
                        }
                        return !1;
                    ...
                    loadMinifest: function (e) {
                        ...
                        var t = this.getTimeFrag(),
                            i =
                                ...
                                this.directory +
                                '/' +
                                this.getMinifestFilename() +
                                '?' +
                                t;
                        return r.get(i, { cache: !e });
                    },
                    loadAndProcessMinifest: function (e) {
                        ...
                        return (
                            ...
                            this.loadMinifest()
                                .then(function (n) {
                                    var i = n.data;
                                    i.refTime && ((i.ref = i.refTime), delete i.refTime),
                                        (t.minifest && !e && t.minifest.ref === i.ref) ||
                                            (t.setMinifest(i),
                                            ...
                                            s.get('product') === t.ident && s.set('calendar', t.calendar),
                                            s.set('lastModified', new Date(t.minifest.ref).getTime()));
                                })
                                .catch(function (e) {
                                    window.wError('Product', 'Minifest load/parsing failed', e);
                                    var n =
                                        (null == e ? void 0 : e.responseText) ||
                                        'Sorry, but we are unable to download data for the ' +
                                            t.modelName +
                                            '. Please check the <a href="https://community.windy.com/category/24/system-status" target="_blank">system status</a> to make sure there is no any outage, or try again later.';
                                    throw (
                                        (new h({
                                            ident: 'message',
                                            className: 'bg-error',
                    ...
                    loadInfo: function (e) {
                        ...
                        var o =
                            ...
                            this.infoVersion +
                            '/info.json';
                        return r.get(o, { ttl: 48 * t.tsHour }).catch(function () {
                    ...
                    checkNewMinifest: function () {
                        ...
                        this.loadAndProcessMinifest().then(function () {
                            (e.loadingPromise = null),
                                s.set('product', e.ident, { forceChange: !0 }).then(function () {
                                    setTimeout(function () {
                                        i.emit('redrawLayers', { noCache: !0 });
                                    }, 1e3);
                                });
                        });
                    },
                    open: function () {
                        ...
                        return (
                            this.refreshInterval ||
                                (this.refreshInterval = setInterval(this.checkNewMinifest.bind(this), 18e5)),
                            n.isMobileOrTablet || this.printLogo(),
                            this.loadingPromise
                                ? this.loadingPromise
                                : Date.now() < this.productExpires
                    ...
                    close: function () {
                        n.isMobileOrTablet || this.removeLogo(),
                    ...
                    pointIsInBounds: function (e) {
                        ...
                        for (var t = +e.lat, n = +e.lon, i = 0; i < this.bounds.length; i++) {
                            for (
                                var o = !1, r = this.bounds[i].length, a = this.bounds[i], s = 0, l = r - 1;
                                s < r;
                                l = s++
                            ) {
                                var c = a[s][0],
        ...
        (s.prototype.getColor = function () {
            ...
            (s.prototype.getParams = function (e, r) {
                    ...
                    f = Object.assign(
                        ...
                        e,
                        {
                            ...
                            level:
                                ...
                                (d = s),
                                l || (d = 'surface'),
                                a && !a.includes(d) && (d = a[0]),
                                '100m' === d && 'wind' !== c && (d = 'surface'),
                                d),
                            fullPath: '',
                        },
                        this.renderParams
                ...
                return (
                    p.ident === r
                        ? Promise.resolve()
                        : this.getCalendar(p.ident).then(function (e) {
                              e &&
                                  ((f.path = e.ts2path(o.get('timestamp'))),
                                  (f.refTime = e.refTime),
                                  (f.level = (u.levels && u.levels[0]) || f.level));
                          })
                ).then(function () {
                    var e = u.isAccu
                        ? '{server}/im/v3.0/{directory}/{refTime}/{acTime}/wm_grid_257/<z>/<x>/<y>/{filename}-surface.{fileSuffix}'
                        : u.pathGenerator || p.pathGenerator;
    ...
    W.define('Overlay', ['layers', 'trans'], function (e, t, n) {
        var i = n.t,
            ...
            r = { metric: { configurable: !0 } };
        (o.prototype.paintLegend = function (e) {
            this.m && this.m.description && this.c
    ...
    W.define('overlays', ['Overlay', 'colors', 'Window'], function (e, t, n, i) {
        var o = i.Window,
            ...
            h = new r({ ident: 'pressure', trans: 'PRESS', icon: 'î€‹', layers: ['windParticles', 'pressure'] }),
            p = new r({ ident: 'rain', trans: 'RAIN_THUNDER', icon: 'î€†', layers: ['windParticles', 'rain'] }),
            f = new r({
                ident: 'clouds',
                trans: 'CLOUDS2',
                icon: '7',
            ...
            A = {
                ...
                airQ: new r({ ident: 'airQ', trans: 'AIR_QUALITY', icon: 'î€', virtual: !0 }),
                gtco3: new r({
                    parentMenu: 'airQ',
                    ident: 'gtco3',
                    trans: 'OZONE',
                ...
                ccl: new r({
                    ...
                    onopen: function () {
                        this.infoWasAlreadyDispayed ||
                            ...
                            this.window.open(),
                            (this.infoWasAlreadyDispayed = !0));
                    },
                    onclose: function () {
                        this.window && this.window.close.call(this.window);
                    },
                }),
                gh: new r({ ident: 'gh', layers: ['gh'] }),
                radarSat: new r({
                    ident: 'radarSat',
                    globeNotSupported: !0,
                    virtual: !0,
                ...
                map: new r({ ident: 'map', trans: 'HMAP', icon: 'î€”', layers: ['map'], hideParticles: !0 }),
                efiWind: new r({
                    icon: 'î€¯',
                    trans: 'EFORECAST',
                    hideParticles: !0,
                ...
                intersucho: new r({ ident: 'intersucho', trans: 'INTERSUCHO', icon: 'î¤„', virtual: !0 }),
                awd_0_40: new r({
                    icon: 'î¤',
    ...
    W.define('metrics', ['Metric', 'trans'], function (e, t, n) {
        var i,
            ...
            h = new c({
                ...
                conv: {
                    ...
                    bft: {
                        conversion: function (e) {
                            for (
                                var t = [0.3, 1.5, 3.3, 5.5, 8, 10.8, 13.9, 17.2, 20.7, 24.5, 28.4, 32.6], n = 0;
                                n < t.length;
                                n++
                            )
                                if (e < t[n]) return n;
            ...
            f = new c({
                ident: 'clouds',
                defaults: ['rules'],
                conv: { rules: { conversion: l, precision: 0 }, '%': { conversion: l, precision: 0 } },
                description: ['rules', '%'],
                lines: [
                    [25, 'FEW', 25],
                    [50, 'SCT', 50],
            ...
            w = new c({
                ident: 'cape',
                defaults: ['J/kg'],
                conv: { 'J/kg': { conversion: l, precision: 0 } },
                description: ['J/kg'],
                lines: [
                    [0, 0],
                    [500, 500],
            ...
            y = new c({
                ident: 'gtco3',
                defaults: ['DU'],
                conv: { DU: { conversion: l, precision: 0 } },
                description: ['DU'],
                lines: [
                    [150, 150],
                    [220, 220],
            ...
            b = new c({
                ident: 'aod550',
                defaults: ['AOD'],
                conv: { AOD: { conversion: l, precision: 3 } },
                description: ['AOD'],
                lines: [
                    [0, 0],
                    [0.25, 0.25],
            ...
            T = new c({
                ident: 'pm2p5',
                defaults: ['Âµg/mÂ³'],
                conv: { 'Âµg/mÂ³': { conversion: l, precision: 0 } },
                description: ['Âµg/mÂ³'],
                lines: [
                    [0, 0],
                    [10, 10],
            ...
            S = new c({
                ident: 'no2',
                defaults: ['Âµg/mÂ³'],
                conv: { 'Âµg/mÂ³': { conversion: l, precision: 2 } },
                description: ['Âµg/mÂ³'],
                lines: [
                    [0, 0],
                    [1, 1],
            ...
            _ = new c({
                ident: 'tcso2',
                defaults: ['mg/mÂ²'],
                conv: { 'mg/mÂ²': { conversion: l, precision: 2 } },
                description: ['mg/mÂ²'],
                lines: [
                    [0, 0],
                    [1, 1],
            ...
            A = new c({
                ...
                conv: {
                    ...
                    ft: {
                        conversion: function (e) {
                            return 100 * Math.round(0.0328 * e);
                        },
                        precision: 0,
                    },
                },
            ...
            I = new c({
                ident: 'dust',
                defaults: ['Âµg/mÂ³'],
                conv: { 'Âµg/mÂ³': { conversion: l, precision: 1 } },
                description: ['Âµg/mÂ³'],
                lines: [
                    [0, 0],
                    [50, 50],
            ...
            N = new c({
                ident: 'cosc',
                defaults: ['ppbv'],
                conv: { ppbv: { conversion: l, precision: 0 } },
                description: ['ppbv'],
                lines: [
                    [0, 0],
                    [50, 50],
            ...
            H = new r({
                ident: 'ptype',
                defaults: ['ptype'],
                conv: { ptype: { conversion: l, precision: 0, label: '' } },
            }),
            G = new c({ ident: 'gh', defaults: ['m'], conv: { m: { conversion: l, precision: 0 } } }),
            z = new c({
                ident: 'fog',
                defaults: ['type'],
                conv: { type: { conversion: l, precision: 0 } },
                description: ['type'],
                lines: [
                    [1, 'Fog'],
                    [2, 'Fog & rime'],
            ...
            B = new c({
                ident: 'lightDensity',
                defaults: ['l/kmÂ²'],
                conv: { 'l/kmÂ²': { conversion: l, precision: 2 } },
                description: ['l/kmÂ²'],
                lines: [
                    [0, 0],
                    [0.025, '.025'],
            ...
            q = new c({
                ident: 'fires',
                defaults: ['W/mÂ²'],
                conv: { 'W/mÂ²': { conversion: l, precision: 3 } },
                description: ['W/mÂ²'],
                lines: [
                    [0, '0'],
                    [0.05, '.05'],
            ...
            Z = {
                ...
                awp: new c({
                    ident: 'awp',
                    defaults: ['awp'],
                    conv: { awp: { conversion: l, precision: 0 } },
                    labels: [
                        'INTERSUCHO_AWP_0',
                        'INTERSUCHO_AWP_1',
                        'INTERSUCHO_AWP_2',
                    ...
                    renderLegend: function (e, t) {
                        ...
                        e.getColor(),
                            (t.style.background = ''),
                            (t.dataset.overlay = 'awp'),
                            (t.innerHTML = (
                                null !==
                                    (n = this.labels.map(function (t, n) {
                                        return n > 0
                                            ? '<span style="text-align:center;background:' +
                                                  e.colorDark(n - 1, 50) +
                                                  ';">' +
                                                  o[t] +
                                                  '</span>'
    ...
    W.define('layers', ['colors', 'metrics', 'Layer', 'legends'], function (e, t, n, i, o) {
        var r = i.WaveLayer,
            ...
            c = new a({ ident: 'capAlerts', renderer: 'capAlerts' }),
            d = new a({ ident: 'pressureIsolines', renderer: 'isolines', levels: ['surface'] }),
            u = new a({
                ident: 'ghIsolines',
                renderer: 'isolines',
                levels: [
            ...
            p = new a({ ident: 'deg0Isolines', renderer: 'isolines', levels: ['surface'] }),
            f = new a({
                ident: 'windParticles',
                renderer: 'particles',
                filename: 'wind',
            ...
            S = new a({ ident: 'wind', renderParams: { renderFrom: 'RG' }, c: t.wind, m: n.wind }),
            _ = new a({ ident: 'temp', c: t.temp, m: n.temp }),
            E = new a({ ident: 'dewpoint', c: t.temp, m: n.temp }),
            A = new a({ ident: 'gust', c: t.wind, m: n.wind }),
            P = new a({
                ident: 'gustAccu',
                isAccu: !0,
                filename: 'gust',
            ...
            L = new a({ ident: 'rh', c: t.rh, m: n.rh }),
            C = new a({ ident: 'pressure', fileSuffix: 'png', PNGtransparency: !0, c: t.pressure, m: n.pressure }),
            M = new a({
                ident: 'ccl',
            ...
            I = new a({ ident: 'lclouds', c: t.lclouds, m: n.clouds }),
            N = new a({ ident: 'mclouds', c: t.mclouds, m: n.clouds }),
            W = new a({ ident: 'hclouds', c: t.hclouds, m: n.clouds }),
            k = new a({ ident: 'cape', c: t.cape, m: n.cape }),
            U = new a({
                ident: 'cbase',
                fileSuffix: 'png',
                PNGtransparency: !0,
            ...
            z = new r({ ident: 'waves' }),
            B = new r({ ident: 'wwaves' }),
            j = new r({ ident: 'swell1' }),
            V = {
                capAlerts: c,
                pressureIsolines: d,
                ghIsolines: u,
                ...
                wwaves: B,
                swell1: j,
                swell2: new r({ ident: 'swell2' }),
                swell3: new r({ ident: 'swell3' }),
                swell: j,
                currents: new a({
                    ident: 'currents',
                    filename: 'seacurrents',
                ...
                sst: new a({
                    ...
                    l: o.sst,
                    pathGenerator:
                        '{server}/im/v3.0/analysis/ecmwf-hres/{refTime}/{refTime}/wm_grid_257/<z>/<x>/<y>/{filename}-{level}.{fileSuffix}',
                }),
                visibility: new a({ ident: 'visibility', c: t.visibility, m: n.visibility }),
                snowcover: new a({
                    ident: 'snowcover',
                ...
                deg0: new a({ ident: 'deg0', levels: ['surface'], c: t.deg0, m: n.altitude }),
                cosc: new a({
                    ident: 'cosc',
                    filename: 'chem_cosc',
                    c: t.cosc,
                ...
                radar: new a({ ident: 'radar', renderer: 'radar', c: t.radar, m: n.radar }),
                satellite: new a({ ident: 'satellite', renderer: 'satellite', c: t.satellite, m: n.satellite }),
                gtco3: new a({ ident: 'gtco3', c: t.gtco3, m: n.gtco3 }),
                pm2p5: new a({ ident: 'pm2p5', c: t.pm2p5, m: n.pm2p5, transformR: l(0.001), wTransformR: 0.001 }),
                no2: new a({ ident: 'no2', c: t.no2, m: n.no2, transformR: l(0.001), wTransformR: 0.001 }),
                aod550: new a({ ident: 'aod550', c: t.aod550, m: n.aod550, transformR: l(0.001), wTransformR: 0.001 }),
                tcso2: new a({ ident: 'tcso2', c: t.tcso2, m: n.tcso2, transformR: l(0.001), wTransformR: 0.001 }),
                go3: new a({ ident: 'go3', c: t.go3, m: n.go3, transformR: l(0.001), wTransformR: 0.001 }),
                gh: new a({ ident: 'gh', m: n.gh }),
                map: new a({ ident: 'map', renderer: 'map' }),
                efiWind: new a({
                    ident: 'efiWind',
                    filename: 'wsi',
    ...
    W.define(
        'models',
        ['store', 'broadcast', 'utils', 'rootScope', 'products', 'layers', 'overlays'],
        function (e, t, n, i, o, r, a, s) {
            var l = (0, i.$)('meta[name="model"]');
            l &&
                l.content &&
                o.globalProducts.includes(l.content) &&
                'ecmwf' !== l.content &&
                t.set('product', l.content);
            var c = {},
                d = {},
                u = Object.keys(r);
            ...
            (e.betterProducts = p),
                ...
                (e.getProduct = function (e, n) {
                    ...
                    (i = i.filter(function (e) {
                        ...
                        console.error(
                            'No products available for overlay "' +
                                e +
                                '" using your API key. Original products: ' +
                                c[e].join(', ')
                        );
    ...
    W.define(
        ...
        function (e, t, n, i, o, r, a, s, l, c, d, u) {
            var h = u.get,
                ...
                m = (l.$, s.Calendar),
                v =
                    '<a href="https://atmosphere.copernicus.eu/" target="_blank"><img style="max-width:150px;height:auto;" src="img/providers/copernicus-white.svg" /></a>',
                g = n.instance({
                    ident: 'ecmwf',
                    ...
                    createBackupMinifest: function () {
                        (this.minifest = {
                            ...
                            (this.calendar = new m({ numOfHours: this.forecastSize, minifestFile: this.minifest }));
                    },
                }),
                w = t.instance({
                    ident: 'cams',
                ...
                R = i.instance({ ident: 'mblue', modelName: p ? 'MBLUE' : 'METEOBLUE' }),
                x = o.instance({
                    ident: 'namConus',
                    modelResolution: 5,
                ...
                U = k.instance({ ident: 'intersuchoAWD', overlays: ['awd_0_40', 'awd_0_100'] }),
                F = k.instance({ ident: 'intersuchoAWP', overlays: ['awp_0_40', 'awp_0_100'] }),
                H = k.instance({ ident: 'intersuchoAWR', overlays: ['awr_0_40', 'awr_0_100'] }),
                G = n.instance({
                    ident: 'ecmwfWaves',
                    modelName: 'ECMWF',
                    modelResolution: 13,
    ...
    W.define('detectDevice', [], function (e) {
        var t,
            ...
            l =
                ...
                (i = Math.min(t, n)),
                (o = Math.max(t, n)),
                (r = /ios|android/.test(s)),
                o <= 600 || (o <= 960 && i <= 600) || (i <= 500 && r)
                    ? 'mobile'
                    : o <= 1024 || (i <= 1080 && r)
                    ? 'tablet'
                    : 'desktop');
    ...
    W.define('device', ['utils', 'storage', 'store'], function (e, t, n, i) {
        ...
        c
            ...
            : (o = l),
            i.get('firstUserSession') || i.set('firstUserSession', Date.now());
    ...
    W.define('rootScope', ['detectDevice'], function (e, t) {
        ...
        (e.acTimes = ['next12h', 'next24h', 'next2d', 'next48h', 'next60h', 'next3d', 'next5d', 'next10d']),
            (e.airQualityProducts = c),
            (e.assets = a),
            (e.community = 'https://community.windy.com'),
            (e.device = r),
            (e.globalPointProducts = u),
            (e.globalProducts = l),
            (e.hereMapsID = 'app_id=Ps0PWVjNew3jM9lpFHFG&app_code=eEg9396D7_C6NCcM1DUK2A'),
            (e.iconsDir = 'img/icons6'),
            (e.isCrawler = f),
            (e.isMobile = m),
            (e.isMobileOrTablet = g),
            (e.isRetina = w),
            (e.isTablet = v),
            (e.isolines = ['off', 'pressure', 'gh', 'temp', 'deg0']),
            (e.levels = [
                'surface',
                '100m',
                '975h',
            ...
            (e.localPointProducts = d),
            (e.localProducts = s),
            (e.nodeServer = 'https://node.windy.com'),
            (e.overlays = [
                'radarSat',
                'radar',
                'satellite',
            ...
            (e.prefLang = y),
            (e.products = h),
            (e.seaProducts = ['ecmwfWaves', 'gfsWaves', 'iconWaves', 'iconEuWaves', 'cmems']),
            (e.server = 'https://ims-s.windy.com'),
            ...
            (e.target = i),
            (e.tileServer = 'https://tiles-s.windy.com'),
            (e.version = n);
    }),
    W.define(
        'trans',
        ['utils', 'rootScope', 'storage', 'store', 'seoParser', 'langEn', 'http'],
        function (e, t, n, i, o, r, a, s) {
            var l,
                c = {
                    ...
                    subscription: { filename: 'lang/subscription/{lang}.json', test: 'SUB_HEADING' },
                    notifications: { filename: 'lang/notifications/{lang}.json', test: 'NOTIF_ALERT_TITLE' },
                    airq: { filename: 'lang/airq/{lang}.json', test: 'AIRQ_US_AIR_QUALITY_INDEX' },
                    radiation: { filename: 'lang/radiation/{lang}.json', test: 'RADIATION_STATION' },
            ...
            function f(e) {
                void 0 === e && (e = '');
                return /\|/.test(e)
                    ? e.replace(/(\w+)\|(\w+):(\w+)/, function (t, n, i, o) {
                          var r = d[n];
                          return r && o ? r.replace(/\{\{[^}]+\}\}/g, o) : e;
                      })
                    : d[e] || e;
            }
            'auto' !== h && t.isValidLang(h) && (p = h),
                p &&
                    (t.isValidLang(p)
                        ? (u = p)
                        : (p = p.replace(/-\S+$/, '')) !== (u = t.isValidLang(p) ? p : 'en') && (l = p));
            var m = function (e, t) {
                    void 0 === t && (t = {});
                    var o = i.get(e);
                    return o &&
                        (t.absoluteURL || o.version === n.version) &&
                        (!t.test || (o.data && t.test && o.data[t.test]))
                        ? Promise.resolve(o.data)
                        : new Promise(function (o, r) {
                              s.get(t.absoluteURL ? e : n.assets + '/' + e, { json: !0 })
                                  .then(function (a) {
                                      var s = a.data;
                                      t.test && !(t.test in s)
                                          ? r('File did not passed the test')
                                          : (i.put(e, { data: s, version: t.absoluteURL ? 'notAplicable' : n.version }),
                                            o(s));
                                  })
                                  .catch(function (e) {
                        ...
                        new Promise(function (i, o) {
                            if (c[e].loaded !== n) {
                                var r = c[e],
                                    a = r.filename,
                                    s = r.test,
                                    l = t.template(a, { lang: n });
                                m(l, { absoluteURL: !1, test: s })
                                    .then(function (t) {
                        ...
                        for (var n = e.querySelectorAll('[data-' + t + ']'), i = 0, o = n.length; i < o; i++) {
                            ...
                            switch (t) {
                                ...
                                case 'tooltipsrc':
                                    ...
                                    break;
                                case 'afterbegin':
                                    r.firstChild && 3 == r.firstChild.nodeType && r.removeChild(r.firstChild),
                                        r.insertAdjacentHTML(t, a);
                                    break;
                                case 'beforeend':
                                    r.lastChild && 3 == r.lastChild.nodeType && r.removeChild(r.lastChild),
                                        r.insertAdjacentHTML(t, a);
                            }
                        }
                    });
    ...
    W.define('store', ['dataSpecifications', 'storage', 'Evented'], function (e, t, n, i) {
        var o = {},
            ...
            s = function (e) {
                ...
                if (!a)
                    throw (
                        (window.wError('store', 'Trying to get invalid dataSpec. ident: ' + e),
                        new Error('Cannot find "' + e + '" key in dataSpecifications'))
                    );
                return (
                    a.save && n.isAvbl
                        ? null === (i = n.get('settings_' + e))
                            ? (i = a.def)
                            : r(a, i) ||
                              (window.wError('store', 'Attempt to get invalid value from localStorage: ' + e),
                              (i = a.def))
                        : (i = a.def),
                    (o[e] = i),
                    i
            ...
            u = function (e, n, i) {
                ...
                if (!o)
                    throw (
                        (window.wError('store', 'Trying to set dataSpec. ident: ' + e),
                        new Error('Cannot find "' + e + '" key in dataSpecifications'))
                    );
                if (!i.doNotCheckValidity && !r(o, n))
                    return console.warn('Invalid value for ' + e + ', ' + n), !!a(o) && Promise.reject();
                        ...
                        if (i.forceChange || c(e, o, n)) {
                            ...
                            return (
                                l
                                    ...
                                    .catch(function (t) {
                                        return window.wError(
                                            'store',
                                            'Unable to change store value ' + e + ', ' + n,
                                            t
                                        );
                                    }),
                                l
            ...
            h = i.instance({
                ...
                set: u,
                remove: function (e, t) {
                    void 0 === t && (t = { doNotCheckValidity: !0 }), u(e, null, t);
                },
                insert: function (e, n) {
                    t[e] = n;
                },
        ...
        function p(e, t, i, r) {
            if ((null === r ? delete o[e] : (o[e] = r), t.save && !i.doNotStore && n.isAvbl)) {
                ...
                n.put('settings_' + e, r),
                    t.sync && ((t.update = a), n.put('settings_' + e + '_ts', a), n.put('lastSyncableUpdatedItem', a)),
                    s('user') && t.sync && !i.doNotSaveToCloud && h.emit('_cloudSync');
            }
            h.emit(e, null === r ? t.def : r, i.UIident);
        }
        h.once('country', function (e) {
            d('hourFormat', /us|uk|ph|ca|au|nz|in|eg|sa|co|pk|my/.test(e) ? '12h' : '24h'),
                u('isImperial', /us|my|lr/.test(e));
        });
    ...
    W.define('dataSpecifications', ['rootScope', 'utils'], function (e, t, n) {
        var i = [!0, !1],
            ...
            u = {
                overlay: { def: 'wind', allowed: t.overlays, save: !1, sync: !1, nativeSync: !1 },
                level: { def: 'surface', allowed: t.levels },
                acTime: { def: 'next3d', allowed: t.acTimes },
                timestamp: { def: Date.now(), allowed: o },
                path: { def: '', allowed: s },
                isolines: { def: 'off', allowed: t.isolines, save: !0 },
                startUpLastProduct: { def: null, allowed: t.products.concat([null]), save: !0, nativeSync: !0 },
                product: { def: 'ecmwf', allowed: t.products },
                availProducts: { def: ['ecmwf'], allowed: Array.isArray, compare: d },
                visibleProducts: { def: ['ecmwf'], allowed: Array.isArray, compare: d },
                availAcTimes: { def: ['next12h'], allowed: Array.isArray },
                prefferedProduct: { def: 'ecmwf', allowed: ['ecmwf', 'gfs', 'icon', 'iconEu'] },
                animation: { def: !1, allowed: i },
                calendar: { def: null, allowed: r },
                availLevels: {
                    def: [].concat(t.levels),
                    allowed: function (e) {
                ...
                lastModified: { def: 0, allowed: o },
                graticule: { def: !1, allowed: i, save: !0, sync: !1 },
                latlon: { def: !1, allowed: i, save: !0, sync: !1 },
                lang: {
                    def: 'auto',
                    allowed: function (e) {
                ...
                englishLabels: { def: !1, allowed: i, save: !0, sync: !0 },
                numDirection: { def: !1, allowed: i, save: !0, sync: !0 },
                favOverlays: {
                    def: [
                        'radar',
                        'satellite',
                ...
                isImperial: { def: !1, allowed: i },
                map: { def: 'sznmap', allowed: ['sznmap', 'sat', 'winter'], save: !0, sync: !1 },
                showWeather: { def: !0, allowed: i, save: !0, sync: !1 },
                disableWebGL: { def: !1, allowed: i, save: !0, sync: !1 },
                glParticlesOn: { def: !1, allowed: i },
                usedLang: { def: 'en', allowed: t.supportedLanguages },
                expertMode: { def: !1, allowed: i, save: !0, sync: !1 },
                lhpaneSwitch: { def: 'tools', save: !0, allowed: ['tools', 'favs', 'settings'] },
                particles: {
                ...
                startUpLastPosition: {
                    ...
                    allowed: function (e) {
                        return (
                            null !== e &&
                            n.isValidLatLonObj(e) &&
                            Number.isInteger(e.zoom) &&
                            ('maps' === e.source || 'globe' === e.source)
                        );
                    },
                    save: !0,
                    nativeSync: !0,
                },
                homeLocation: { def: null, allowed: a, save: !0, sync: !0, nativeSync: !0 },
                startUpOverlay: { def: 'wind', allowed: t.overlays, save: !0, nativeSync: !0 },
                startUpLastOverlay: { def: !1, allowed: i, save: !0, nativeSync: !0 },
                startUpLastStep: { def: null, allowed: [1, 3, null], save: !0, nativeSync: !0 },
                ipLocation: { def: null, allowed: a, save: !0, nativeSync: !0 },
                gpsLocation: { def: null, allowed: a, save: !0, nativeSync: !0 },
                startupReverseName: { def: null, allowed: r, save: !0 },
                notams: { def: null, allowed: r, save: !0, sync: !0 },
                email: {
                    def: '',
                    allowed: function (e) {
                        return /\S+@\S+/.test(e);
                ...
                metarsRAW: { def: !1, allowed: i, save: !0, sync: !0 },
                sessionCounter201803: { def: 0, allowed: o, save: !0 },
                sessionCounter: { def: 0, allowed: o, save: !0 },
                firstUserSession: { def: 0, allowed: o, save: !0 },
                seenRadarInfo: { def: !1, save: !0, allowed: i },
                wasDragged: { def: !1, allowed: i, save: !0, sync: !0 },
                detailLocation: { def: null, allowed: a },
                detailDisplay: { def: 'table', allowed: ['table', 'meteogram', 'airgram', 'waves', 'wind'] },
                detailProduct: {
                    def: 'ecmwf',
                    allowed: [
                        'ecmwf',
                ...
                detailAvailProducts: { def: ['ecmwf'], allowed: Array.isArray, compare: d },
                detailExtended: { def: !1, allowed: i },
                detail1h: { def: !1, allowed: i },
                webcamsDaylight: { def: !1, allowed: i },
                capColorizeType: { def: 'severity', allowed: ['severity', 'type'] },
                capDisplay: { def: 'all', allowed: ['all', 'today', 'tomm', 'later'] },
                radarRange: { def: '-1', allowed: ['-12', '-6', '-1'] },
                radarTimestamp: { def: Date.now(), allowed: o },
                radarSpeed: { def: 'medium', allowed: ['slow', 'medium', 'fast'] },
                radarCalendar: { def: null, allowed: r },
                radarAnimation: { def: !1, allowed: i },
                blitzOn: { def: !0, allowed: i, save: !0 },
                blitzSoundOn: { def: !0, allowed: i, save: !0 },
                satelliteRange: { def: 'short', allowed: ['long', 'medium', 'short'] },
                satelliteTimestamp: { def: Date.now(), allowed: o },
                satelliteCalendar: { def: null, allowed: r },
                satelliteAnimation: { def: !1, allowed: i },
                satelliteMode: {
                    def: 'BLUE',
                ...
                satelliteFlowOn: { def: !0, allowed: i, save: !0, sync: !1 },
                satelliteExtraOn: { def: !0, allowed: i, save: !0 },
                satelliteInterpolationOverride: { def: !1, allowed: i },
                hpShown: { def: !1, allowed: i },
                pois: { def: 'favs', allowed: Object.keys(t.pois), save: !0, sync: !1 },
                favPois: {
                ...
                visibility: { def: !0, allowed: i },
                displayLocation: { def: !0, allowed: i, save: !0 },
                vibrate: { def: !0, allowed: i, save: !0 },
                donations: { def: [], allowed: Array.isArray, compare: d, save: !0, sync: !0 },
                zuluMode: { def: !1, allowed: i, save: !0 },
                plugins: { def: [], allowed: Array.isArray, compare: d, save: !0, sync: !0 },
                pluginOrder: { def: [], allowed: Array.isArray, save: !0 },
                stationsSort: { def: 'profi', allowed: ['profi', 'distance'], save: !0 },
                stationCompareModel: { def: 'noModel', allowed: s, save: !0 },
                subscription: {
                    def: null,
                    allowed: function (e) {
                        return !0;
                ...
                pendingSubscription: { def: null, allowed: l, save: !0 },
                failedSubscriptionPayment: { def: null, allowed: l, save: !0 },
                motionSpeed: { def: 10, allowed: o, save: !0 },
                notifications: { def: null, allowed: r, save: !0, sync: !0 },
                adHocNotification: { def: !1, allowed: i, save: !0, nativeSync: !0 },
                badgeNumber: { def: 0, allowed: o, save: !0 },
                user: { def: null, allowed: r, nativeSync: !0 },
                userToken: { def: null, allowed: s, save: !0, nativeSync: !0 },
                authHash: { def: null, allowed: s, save: !0, nativeSync: !0 },
                globeActive: { def: !1, allowed: i },
                lastPoiLocation: { def: null, allowed: a },
                pickerLocation: {
                    def: null,
                    allowed: function (e) {
                        return null === e || a(e);
                ...
                settingsLastSaved: { def: 0, allowed: o },
                renderedTime: { def: 0, allowed: o },
                loadedTime: { def: 0, allowed: o },
                mapCoords: { def: null, allowed: a },
                unresolvedErrors: { def: [], allowed: Array.isArray, save: !1, nativeSync: !1 },
                closedErrors: { def: [], allowed: Array.isArray, save: !0, nativeSync: !0 },
                launchedBy: { def: null, allowed: s },
                showDailyNotifications: { def: !1, allowed: i, nativeSync: !0, save: !0 },
            };
        e.default = u;
    }),
    W.define('colors', ['Color'], function (e, t) {
        var n = {
            ...
            currents: t.instance({ ident: 'currents', defaultKey: 'seacurrents', steps: 256 }),
            currentsTide: t.instance({ ident: 'currentsTide', defaultKey: 'seacurrents_tide', steps: 256 }),
            ...
            gtco3: t.instance({ ident: 'gtco3', steps: 512 }),
            aod550: t.instance({ ident: 'aod550', steps: 8e3 }),
            pm2p5: t.instance({ ident: 'pm2p5', steps: 4e3 }),
            no2: t.instance({ ident: 'no2', steps: 4e3 }),
            tcso2: t.instance({ ident: 'tcso2', steps: 4096 }),
            go3: t.instance({ ident: 'go3', steps: 4096 }),
            so2: t.instance({
                ident: 'so2',
                steps: 8e3,
                default: [
            ...
            efiWind: t.instance({ ident: 'efiWind', steps: 256, defaultKey: 'wsi' }),
            efiTemp: t.instance({ ident: 'efiTemp', steps: 256, defaultKey: 'ti' }),
            efiRain: t.instance({ ident: 'efiRain', steps: 256, defaultKey: 'tpi' }),
            fires: t.instance({ ident: 'fires', steps: 8e3, defaultKey: 'frpfire' }),
            awd_0_40: t.instance({ ident: 'awd_0_40', steps: 8e3 }),
            awd_0_100: t.instance({ ident: 'awd_0_100', steps: 8e3 }),
            awp_0_40: t.instance({ ident: 'awp_0_40', steps: 8e3 }),
            awp_0_100: t.instance({ ident: 'awp_0_100', steps: 8e3 }),
            awr_0_40: t.instance({ ident: 'awr_0_40', steps: 8e3 }),
            awr_0_100: t.instance({ ident: 'awr_0_100', steps: 8e3 }),
        };
        e.default = n;
    }),
    W.define(
        'geolocation',
        ['rootScope', 'utils', 'http', 'store', 'broadcast', 'router', 'showableErrorsService'],
        function (e, t, n, i, o, r, a, s) {
            function l(e, t, n) {
                return (
                    t in e
            ...
            var c = function () {
                ...
                d = function (e) {
                    void 0 === e && (e = { enableHighAccuracy: 'android' === t.platform, timeout: 7e3 });
                    var n = function (e, t) {
                        ...
                        i = function (e, n) {
                            var i = {
                                errorId:
                                    'location disabled' === n.message && 'android' === t.platform ? 'LOC_1' : 'LOC_2',
                                category: 'location',
                            };
                            s.add(i), e(c());
                        },
                ...
                h = function (e, t, n, i, a) {
                    ...
                    var s = { ts: Date.now(), source: a, lat: parseFloat(e), lon: parseFloat(t), name: i || u(e, t) };
    ...
    W.define(
        'params',
        ['utils', 'store', 'models', 'overlays', 'broadcast', 'products', 'subscription', 'router', 'renderCtrl'],
        function (e, t, n, i, o, r, a, s, l, c) {
            function d(e) {
                var t = n.get('overlay'),
                    i = {
                        overlay: t,
            ...
            n.setDefault('calendar', p),
                n.setDefault('path', p.ts2path(Date.now())),
                n.defineProperty('timestamp', 'syncSet', function (e) {
                ...
                n.defineProperty('product', 'asyncSet', function (e) {
                    return new Promise(function (i, o) {
                        var r = a[e];
                        a[n.get('product')].close(),
                            r
                                .open()
                                .then(function (o) {
                                    t.replaceClass(/product-\S+/, 'product-' + e),
                                        o &&
                                            (n.set('calendar', o),
                                            n.set('timestamp', t.bound(n.get('timestamp'), o.start, o.end), {
                                                forceChange: !0,
                                            })),
                                        r.levels &&
                                            (n.set('availLevels', r.levels),
                                            r.levels.includes(n.get('level')) || n.set('level', 'surface')),
                                        r.acTimes &&
                                            (n.set('availAcTimes', r.acTimes),
                                            !r.acTimes.includes(n.get('acTime')) &&
                                                r.acTimes.length > 0 &&
                                                n.set('acTime', r.acTimes[0])),
                                        n.set('prefferedProduct', r.prefferedProduct),
                                        i(e);
                                })
                                .catch(o);
                    });
            ...
            var f = function (e, r) {
                var a = o[e],
                    s = o[r];
                t.replaceClass(/overlay-\S+/, 'overlay-' + e),
                    t.toggleClass(document.body, Boolean(a && a.hasMoreLevels), 'has-more-levels'),
                    t.toggleClass(document.body, Boolean(a && a.hideParticles), 'hide-particles'),
                    n.set('availProducts', i.overlay2product[e]),
                    s && s.onclose && s.onclose.call(s),
                    a && a.onopen && a.onopen();
            };
            n.defineProperty('overlay', 'asyncSet', function (e) {
                var t = n.get('overlay'),
                    o = i.getProduct(e, n.get('product'));
                return o === n.get('product')
                    ? (f(e, t), Promise.resolve(e))
    ...
    W.define('connection', ['broadcast', 'Window'], function (e, t, n) {
        ...
        function s(e) {
            ...
            t.open('HEAD', 'https://node.windy.com/node/connection', !0),
                ...
                ? ((o = !0),
                  ...
                  setTimeout(function () {
                      (a = new i({
                          ...
                          t.emit('connectionRestored');
                  }, 500))
                : setTimeout(s.bind(null, l), 2e3);
        }
    ...
    W.define(
        'deviceLogging',
        ['http', 'rootScope', 'storage', 'utils', 'device', 'store'],
        function (e, t, n, i, o, r, a) {
            var s = function (e) {
                return t
                    .put('/users/v3/devices/' + e.deviceID, { data: e })
                    .then(function () {
                ...
                (e.saveCurrentDevice = function (e) {
                    if (a.get('user')) {
                        ...
                        window &&
                            ...
                            'mobile' === n.target &&
                                e &&
                                ((t.registrationHash = e), (t.notifPluginVersion = 'Capacitor' in window ? 2 : 1));
                        var l = i.get('lastSentDevice');
                        (!l ||
                            l.deactivated ||
                            t.deviceID !== l.deviceID ||
                            (l.updated && l.updated + 24 * o.tsHour < Date.now()) ||
                            (t.notifPluginVersion && t.notifPluginVersion !== l.notifPluginVersion) ||
            ...
            l = o.instance({
                ...
                _init: function () {
                    ...
                    t()
                        ? r.get('user')
                            ? this.watchChanges()
                            : r.once('user', this.watchChanges, this)
                        : i.on('favsChanged', function () {
                ...
                watchChanges: function () {
                    var e = this;
                    (this.canRecieveNotif = !0),
                        this.emit('canRecieveNotif'),
                        (this.eventSource = n.createEventSource('/notif/v1/notifications/stream')),
                ...
                loadNotificationList: function (e, t) {
                    var i = this,
                        o = { current: e, pageSize: t };
                    return (
                        1 === e && (o.markAsViewed = !0),
                        n
                            .get('/notif/v1/notifications', { cache: !1, qs: o })
                            .then(function (e) {
                                var t = e.data;
                ...
                markNotificationsAsReceived: function () {
                    return n.put('/notif/v1/notifications', { qs: { status: 'received' } }).catch(function (e) {
                ...
                markAllAsSeen: function () {
                    (this.data.newCount = 0),
                        r.set('badgeNumber', 0),
                        a && a.removeAllDeliveredNotifications(),
                        s &&
                            s.getPending().then(function (e) {
                ...
                updateInfo: function (e) {
                    var t = e.totalCount,
                        n = e.newCount;
                    (this.data = { totalCount: t, newCount: n }), r.set('badgeNumber', n);
                },
            });
        e.default = l;
    }),
    W.define('showableErrorsService', ['utils', 'store', 'favs'], function (e, t, n, i) {
        var o = null,
            ...
            l = function (e) {
                ...
                (t = r(e, t)), n.set('unresolvedErrors', t, { forceChange: !0 }), a();
            };
        function c(e) {
            switch (e.category) {
                case 'location':
                    'LOC_1' === e.errorId
                        ? (function (e) {
                              ...
                              o.isGpsEnabled().then(
                                  ...
                                  function (e) {
                                      window.wError(
                                          'ShowableErrorsService',
                                          'ShowableErrorsService checkLocationServices error',
                                          e
                                      );
                                  }
                              );
                        ...
                        : (function (e) {
                              if (!o) return;
                              o.getLocationPermnissions().then(
                                  function (t) {
                                      t && 'authorized' === t.status && l(e.errorId);
                                  },
                                  function (e) {
                ...
                case 'notification':
                    !(function (e) {
                        if (!o) return;
                        o.getNotificationPermnissions().then(
                            function (t) {
                                t && 'authorized' === t.status && l(e.errorId);
                            },
                            function (e) {
                                window.wError(
                                    'ShowableErrorsService',
                                    'ShowableErrorsService chechNotificationSercices error',
                                    e
                                );
                            }
                        );
                ...
                case 'battery':
                    !(function (e) {
                        if (!o) return;
                        o.getBatteryUsagePermissions().then(
                            function (t) {
                                t && 'authorized' === t.status && l(e.errorId);
                            },
                            function (e) {
                                window.wError(
                                    'ShowableErrorsService',
                                    'ShowableErrorsService checkBatteryServices error',
                                    e
                                );
                            }
                        );
        ...
        [{ errorId: 'BATTERY_1', category: 'battery' }].forEach(s);
        var d = {
            add: s,
            close: function (e) {
                var t = n.get('unresolvedErrors'),
                ...
                (t = r(e, t)),
                    i.push(e),
                    n.set('unresolvedErrors', t, { forceChange: !0 }),
                    n.set('closedErrors', i, { forceChange: !0 }),
                    a();
            },
            resolve: l,
        ...
        var o = i.loadLangFile,
            r = function (e) {
                ...
                this.initProperties(),
                    ...
                    (this.redraw = null !== (o = e.redraw) && void 0 !== o ? o : this.redraw);
            };
        (r.prototype.getAssetsLocation = function () {
            return this.location
                ? 'http' === this.location.substr(0, 4)
                    ? this.location
                    : n.joinPath('https://www.windy.com/js', this.location)
            ...
            (r.prototype.load = function () {
                ...
                var i = this.dependencies.map(function (t) {
                    var n;
                    return null !== (e = null === (n = W.plugins[t]) || void 0 === n ? void 0 : n.load()) &&
                        void 0 !== e
                        ? e
                        : Promise.reject();
                });
                return (
                    ...
                    Promise.all(i)
                        .then(function () {
                            if (!t.coreLoaded)
                                return n.loadScript(t.getAssetsLocation()).then(function () {
                                    t.coreLoaded = !0;
                                });
                        })
                        .then(function () {
                        ...
                        .catch(function (e) {
                            throw (
                                ((t.loading = !1),
                                window.wError('plugin', 'Failed to load/resolve dependencies: ' + t.ident, e),
                                e)
                            );
                        })
                );
            ...
            (r.prototype.paramsChanged = function () {}),
            (r.prototype.initProperties = function () {
    ...
    W.define(
        'WindowPlugin',
        ['Plugin', 'Window', 'trans', 'BottomSlide', 'utils', 'broadcast', 'rootScope'],
        function (e, t, n, i, o, r, a, s) {
            var l = r.$,
                c = i.t,
                d = n.Window,
                u = (function (e) {
                    function t(t) {
                        ...
                        e.call(this, t),
                            (this.unmountOnClose =
                                null !== (n = t.unmountOnClose) && void 0 !== n ? n : this.unmountOnClose),
                            (this.hasURL = null !== (i = t.hasURL) && void 0 !== i ? i : this.hasURL),
                            (this.title = t.title),
                            (this.addMobileSlider =
                                null !== (o = t.addMobileSlider) && void 0 !== o ? o : this.addMobileSlider),
                            (this.closeOnSwipeDown =
                                null !== (r = t.closeOnSwipeDown) && void 0 !== r ? r : this.closeOnSwipeDown),
                            (this.noCloseOnBackButton = t.noCloseOnBackButton),
                            (this.hook = t.hook),
                            (this.interpolator = t.interpolator),
                            (this.close = null !== (a = t.close) && void 0 !== a ? a : this.close),
                            (this.onurl = null !== (s = t.onurl) && void 0 !== s ? s : this.onurl),
                            (this.onopen = null !== (l = t.onopen) && void 0 !== l ? l : this.onopen),
                            (this.onclose = null !== (c = t.onclose) && void 0 !== c ? c : this.onclose),
                            (this.onclosed = null !== (d = t.onclosed) && void 0 !== d ? d : this.onclosed),
                            (this.window = this.createWindow(t));
                    }
                    e && (t.__proto__ = e),
                        (t.prototype = Object.create(e && e.prototype)),
                        (t.prototype.constructor = t);
                    var n = { refs: { configurable: !0 }, node: { configurable: !0 }, domEl: { configurable: !0 } };
                    return (
                        (t.prototype.open = function (e, t) {
                            ...
                            return this.isLoaded
                                ? (i(), Promise.resolve())
                                : ((this.loading && this.promise) ||
                                      ((this.promise = this.load()), this.promise.then(i)),
                                  this.promise);
                        }),
                            ...
                            if (t)
                                return (
                                    t.css &&
                                        !this.cssInserted &&
                                        ((this.cssInserted = !0),
                                        document.head.insertAdjacentHTML('beforeend', '<style>' + t.css + '</style>')),
                                    (t.wasLoaded = !1),
                                    (this.window.html = t.html || ''),
                                    this.window.mount(),
                                    { module: t, id: e }
                                );
                        ...
                        (t.prototype.mount = function () {
                            ...
                            t &&
                                n &&
                                (t.callback && 'function' == typeof t.callback && W.require(n, this),
                                (this.isMounted = !0),
                                this.onmounted());
                        }),
                        ...
                        (t.prototype.url = function (e, t) {
                            Promise.resolve(this.onurl(e, t)).then(function (e) {
                                W.location.setUrl(e.url, e.visibleUrl, e.search),
                                    e.title && W.location.setTitle(e.title);
                            });
                        }),
        ...
        var n = (function (e) {
            ...
            return (
                ...
                (t.prototype.load = function () {
                    return (
                        (this.promise = e.prototype.load.call(this)),
                        this.promise.then(this.open.bind(this)),
                        this.promise
                    );
                }),
                (t.prototype.initProperties = function () {
        ...
        var i = n.$,
            o = (function (e) {
                function t(t) {
                    var n;
                    e.call(this, t),
                        (this.beforeOpen = null !== (n = t.beforeOpen) && void 0 !== n ? n : this.beforeOpen);
                }
                return (
                    e && (t.__proto__ = e),
                    (t.prototype = Object.create(e && e.prototype)),
                    (t.prototype.constructor = t),
                    (t.prototype.beforeOpen = function (e, t) {}),
                    ...
                    (t.prototype.onopen = function () {
                        ...
                        return this.svelteApp && this.svelteApp.onopen
                            ? this.svelteApp.onopen.apply(this, t)
                            : e.prototype.onopen.call(this, t);
                    }),
                    (t.prototype.onclose = function () {
                        for (var t = [], n = arguments.length; n--; ) t[n] = arguments[n];
                        return this.svelteApp && this.svelteApp.onclose
                            ? this.svelteApp.onclose.apply(this, t)
                            : e.prototype.onclose.call(this, t);
                    }),
                    (t.prototype.onurl = function () {
                        for (var t = [], n = arguments.length; n--; ) t[n] = arguments[n];
                        return this.svelteApp && this.svelteApp.onurl
                            ? this.svelteApp.onurl.apply(this, t)
                            : e.prototype.onurl.call(this, t);
                    }),
                    (t.prototype.initProperties = function () {
                    ...
                    (t.prototype.mount = function () {
                        ...
                        if (e) {
                            ...
                            if (!t || !n)
                                throw new Error(
                                    'Cannot mount Svelte plugin ' +
                                        this.ident +
                                        ', target element does not exist or does not contain closing element!'
                                );
                            var o = W.require(e, this);
                            (this.svelteApp = new o({ target: t, anchor: n })), (this.isMounted = !0), this.onmounted();
                        }
                    }),
                    (t.prototype.unmount = function () {
                        var e;
                        this.node &&
                            (this.unmountOnClose && this.svelteApp
    ...
    W.define(
        'plugins',
        ['rootScope', 'Plugin', 'TagPlugin', 'AutoOpenPlugin', 'SveltePlugin', 'urls', 'http', 'broadcast'],
        function (e, t, n, i, o, r, a, s, l) {
            var c = r.SveltePlugin,
                ...
                h = n.Plugin,
                p = {
                    geodesic: new h({ ident: 'geodesic', location: 'geodesic110.js' }),
                    d3: new h({ ident: 'd3', location: 'd3.v0507.custom01.js' }),
                    colorpicker: new h({ ident: 'colorpicker', location: 'colorpicker.js' }),
                    graticule: new h({ ident: 'graticule', location: 'graticule20.js' }),
                    'fastspring-builder': new h({ ident: 'fastspring-builder', location: 'fastspring-builder.js' }),
                    nouislider: new d({ ident: 'nouislider', location: 'nouislider.v0805.js' }),
                    airgram: new h({ ident: 'airgram' }),
                    'gl-particles': new h({ ident: 'gl-particles' }),
                    gestures: new d({ ident: 'gestures' }),
                    particles: new h({ ident: 'particles' }),
                    'store-settings': new h({ ident: 'store-settings' }),
                    'detail-render': new h({ ident: 'detail-render' }),
                    patternator: new h({ ident: 'patternator' }),
                    'gl-tile-render': new h({ ident: 'gl-tile-render' }),
                    'cap-utils': new h({ ident: 'cap-utils' }),
                    seo: new h({ ident: 'seo' }),
                    nearest: new h({ ident: 'nearest' }),
                    'plugin-data-loader': new h({ ident: 'plugin-data-loader' }),
                    flatpickr: new d({ ident: 'flatpickr' }),
                    fullscreen: new h({ ident: 'fullscreen' }),
                    notifications: new h({ ident: 'notifications' }),
                    'subscription-services': new h({ ident: 'subscription-services', langFiles: ['subscription'] }),
                    isolines: new u({ ident: 'isolines', hasURL: !1 }),
                    patch: new d({
                        ident: 'patch',
                        location:
                            'https://www.windy.com/patch/lib/latest/patch.js?refTime=' +
                            new Date().toISOString().replace(/^(.*):.*$/, '$1'),
                        hasURL: !1,
                    }),
                    'gl-lib': new d({ ident: 'gl-lib', hasURL: !1 }),
                    lightnings: new d({ ident: 'lightnings', hasURL: !1 }),
                    'radar-sat': new d({ ident: 'radar-sat', hasURL: !1 }),
                    radar: new u({
                        ident: 'radar',
                        title: 'RADAR',
                        hasURL: !1,
                    ...
                    'share-mobile': new u({ ident: 'share-mobile', hasURL: !1 }),
                    overlays: new u({
                    ...
                    detail: new u({
                        ident: 'detail',
                        keyboard: !0,
                        dependencies: t.isMobileOrTablet
                            ? ['detail-render', 'nearest']
                            : ['rhpane', 'detail-render', 'nearest'],
                    ...
                    'poi-libs': new u({ ident: 'poi-libs', hasURL: !1 }),
                    menu: new u({
                        ident: 'menu',
                    ...
                    picker: new u({ ident: 'picker', hasURL: !1, className: 'picker' }),
                    waves: new u({ ident: 'waves', hasURL: !1 }),
                    wind: new u({ ident: 'wind', hasURL: !1 }),
                    ...
                    screenshot: new u({ ident: 'screenshot', dependencies: ['upload'], hasURL: !0 }),
                    settings: new c({
                        ident: 'settings',
                    ...
                    animate: new c({ ident: 'animate', exclusive: 'all', keyboard: !0, title: 'Create Animation' }),
                    airport: new u({
                        ident: 'airport',
                        className: t.isMobile ? 'plugin-mobile-bottom-slide' : 'plugin-lhpane top-border',
                    ...
                    share: new c({ ident: 'share', title: 'SHARE', hasURL: !1, keyboard: !0, className: 'window' }),
                    widgets: new c({
                        ident: 'widgets',
                        exclusive: 'all',
                        langFiles: ['widgets'],
                        ...
                        keyboard: !0,
                        addMobileSlider: !0,
                        className: t.isMobile
                            ? 'plugin-mobile-bottom-slide no-header dark-content'
                            : 'plugin-rhpane top-border',
                    }),
                    multimodel: new c({
                        ident: 'multimodel',
                    ...
                    rplanner: new u({
                        ident: 'rplanner',
                        onurl: function () {
                            return { url: 'distance', title: null };
                        },
                        unmountOnClose: !0,
                        exclusive: 'all',
                    ...
                    upload: new u({ ident: 'upload', hasURL: !1 }),
                    subscription: new c({
                        ident: 'subscription',
    ...
    W.define('pluginsCtrl', ['rootScope', 'plugins', 'broadcast', 'utils'], function (e, t, n, i, o) {
        ...
        function l(e) {
            ...
            var c =
                    'rplanner' === e && t.isMobileOrTablet
                        ? 'distance'
                        : 'distance' !== e || t.isMobileOrTablet
                        ? e
                        : 'rplanner',
                d = r(c) && n[c];
            d &&
                (d.exclusive &&
                    'neverClose' !== d.exclusive &&
                    ('all' === d.exclusive
                        ? o.each(n, function (t, n) {
                              t.isOpen && n !== e && a(n);
                          })
                        : 'rhpane' === d.exclusive || 'lhpane' === d.exclusive
                        ? (['detail', 'rplanner', 'station', 'webcams-detail'].forEach(function (e) {
                              var t = n[e];
                              t.close.call(t);
                          }),
                          t.isMobile ? (s(e, 'rhpane'), s(e, 'lhpane')) : s(e, d.exclusive))
                        : s(e, d.exclusive)),
                d.open.apply(d, i));
        }
        i.on('rqstOpen', l),
            i.on('rqstClose', a),
            i.on('closeAllPlugins', function (e) {
                void 0 === e && (e = []),
                    o.each(n, function (t, n) {
        ...
        var a = o.extend(n, i, {
            ...
            _init: function () {
                (this.left = 0),
                    ...
                    (this.el = this.timecode = t.$('.main-timecode', this.progressBar)),
                    (this.text = t.$('.box', this.timecode)),
                    (this.progressLine = t.$('.progress-line', this.progressBar)),
                    (this.b = t.$('.progress-line i', this.progressBar)),
                    (this.played = t.$('.progress-line .played', this.progressBar)),
                    (this.ghost = t.$('.ghost-timecode', this.progressBar)),
                    (this.ghostTxt = this.ghost && t.$('.box', this.ghost)),
                    n._init.call(this),
                    o._init.call(this),
                    r.isMobile || i._init.call(this),
            ...
            update: function (e) {
                return (
                    (this.left = t.bound(e, 0, this.maxWidth)),
            ...
            onresize: function () {
                if (this.calendar) {
                    if (
                        ...
                        (this.progressLine.style.width = t.bound(this.maxWidth, 0, this.progressWidth) + 'px'),
            ...
            updateGhost: function (e) {
                ...
                (this.ghost.style.left = n + this.offset + 'px'),
                    this.jumpingGhost &&
                        (this.ghost.style.marginTop =
                            this.left - n < 40 && n - this.left < this.jumpingWidth ? '-25px' : '0px'),
                    (this.ghostTxt.textContent = this.createGhostText(n));
            },
        });
        e.default = a;
    }),
            ...
            o = t.extend({
                ...
                _init: function () {
                    (this.dragging = !1),
                        ...
                        (this.bindedStart = this.startDrag.bind(this)),
                ...
                startDrag: function (e) {
                    ...
                    var n = this.getX(e),
                        ...
                        c = function () {
                            var e = Date.now(),
                                ...
                                r = o - l;
                            (a = e), (l = o), (s = i(0.8 * ((1e3 * r) / (1 + n)) + 0.2 * s, -500, 500));
                        },
                        d = setInterval(c, 100);
                    ...
                    var u = function (e) {
                        ...
                        h = function () {
                            ...
                            Math.abs(n) > 0.5 &&
                                e < 3e3 &&
                                ((t.scrollEl.scrollLeft = r + n), (t.inertiaAnim = window.requestAnimationFrame(h)));
                        },
                        p = function () {
                            clearInterval(d),
                                ...
                                Math.abs(s) > 10 &&
                                    ((o = 0.6 * s),
                                    (r = t.scrollEl.scrollLeft + o),
                                    (a = Date.now()),
                                    (t.inertiaAnim = window.requestAnimationFrame(h))),
                                e.preventDefault(),
                                e.stopPropagation();
                        };
            ...
            r = t.extend({
                ...
                onevent: function (e) {
                    ...
                    if (!e || !(e.target instanceof HTMLElement || e.target instanceof SVGElement))
                        throw new Error('Event target is not instance of HTMLElement or SVGElement');
                    var n,
                        i = e.target,
                        o = Boolean('A' === i.nodeName && (null === (t = i.href) || void 0 === t ? void 0 : t.length));
                    for (
                        this.stopPropagation && !o && (e.preventDefault(), e.stopPropagation());
                        i && i !== this.el;
    ...
    W.define(
        'OverlaysMenu',
        ['overlays', 'store', 'trans', 'rootScope', 'utils', 'BindedSwitch', 'format'],
        function (e, t, n, i, o, r, a, s) {
            var l = i.t,
                c = a.extend({
                    bindStore: 'overlay',
                    _init: function () {
                        a._init.call(this),
                            n.on('favOverlays', this.render, this),
                            n.on('expertMode', this.render, this);
                    },
                    render: function () {
                    ...
                    unfold: function (e) {
                        for (
                            var n = t[e],
                                i = (n && n.parentMenu) || e,
                                o = this.el.querySelectorAll('[data-parent]'),
                                a = 0;
                            a < o.length;
                            a++
                        ) {
                        ...
                        var m = e
                            .map(function (e) {
                                ...
                                return (
                                    ...
                                    '"\n                        \n                        ' +
                                    (!a && s && m
                                        ? 'class="sub-menu' + (c ? ' globe-not-supported' : '') + '"'
                                        : c
                                        ? 'class="globe-not-supported"'
                                        : '') +
                                    '>\n                        <div class="iconfont noselect notap">' +
                                    o +
    ...
    W.define(
        'ProductSwitch',
        ['BindedSwitch', 'products', 'store', 'rootScope', 'trans', 'utils'],
        function (e, t, n, i, o, r, a) {
            var s = a.$,
                l = r.t,
                c = t.extend({
                    ...
                    _init: function () {
                        t._init.call(this),
                            i.on('availProducts', this.redraw, this),
                            i.on('visibleProducts', this.redraw, this),
                            i.on('product', this.redraw, this),
                            this.redraw();
                    },
                    getEl: function (e) {
                        ...
                        var r,
                            ...
                            s = function (e) {
                                ...
                                return (
                                    ...
                                    e +
                                    '" class="i' +
                                    (a.includes(e) ? '' : ' disabled') +
                                    '">' +
                                    t.modelName +
                                    (o.showResolution && t.modelResolution
                                        ? '<small>' + t.modelResolution + 'km</small>'
                                        : '') +
                                    '</div>'
                                );
                            },
    ...
    W.define('Resizable', ['utils', 'broadcast', 'Class'], function (e, t, n, i) {
        var o = t.debounce,
            r = i.extend({
                _init: function () {
                    window.addEventListener('resize', o(this.resize.bind(this), 300)),
                        n.on('pluginOpened', this.uiChanged, this),
                        n.on('pluginClosed', this.uiChanged, this),
                        n.on('detailRendered', this.resize, this),
                        n.on('uiChanged', this.uiChanged, this),
                        (this.rects = { left: -1 }),
                        this.resize();
                },
                uiChanged: function () {
        ...
        var i = t.extend({
            ...
            scrollTo: function (e) {
                var t = this,
                    ...
                    s = function () {
                        var e = Date.now();
                        (t.scrollEl.scrollLeft = n.smoothstep(o, a, e) * r + i),
                            e < a && window.requestAnimationFrame(s);
                    };
                s();
            },
            onscroll: function () {},
    ...
    W.define(
        'Webcams',
        ['store', 'map', 'trans', 'http', 'format', 'ClickHandler', 'broadcast', 'metrics', 'urls'],
        function (e, t, n, i, o, r, a, s, l, c) {
            var d = i.t,
                u = n.map,
                h = n.markers,
                p = a.extend({
                    ...
                    addListeners: function () {
                        return (
                            this.hasListener || (t.on('webcamsDaylight', this.render, this), (this.hasListener = !0)),
                            this
                        );
                    },
                    unmount: function () {
                        this.hasListener && (t.off('webcamsDaylight', this.render, this), (this.hasListener = !1)),
                            this.removeMarker();
                    },
                    load: function (e) {
                        var t = this;
                        return (
                            this.removeMarker(),
                            (this.currentLocation = L.latLng(e.lat, e.lon)),
                            new Promise(function (n) {
                                var i = c.getWebcamsList(e);
                                o.get(i, { cache: !e.forceReload }).then(function (e) {
                                    var i = e.data;
                                    (t.daylight = !1),
                                        i.cams.length > 0
                                            ? ((t.data = i.cams.slice(0, t.maxAmount)), t.render())
                                            : ((t.data = []), t.el && (t.el.innerHTML = '')),
                                        n(t.data);
                                });
                            })
                        );
                    ...
                    addMarker: function (e) {
                        this.marker
                            ? this.marker.setLatLng(this.index2location(e))
                            : (this.marker = L.marker(this.index2location(e), {
                                  icon: h.webcamIcon,
                                  zIndexOffset: 1e3,
                              }).addTo(u));
                    },
                    ...
                    render: function () {
                        ...
                        if (this.data && this.data.length) {
                            ...
                            (this.el.innerHTML = this.data
                                .map(function (t, i) {
                                    var o = r.howOld({ ts: (n && t.lastDaylight) || t.lastUpdate, translate: !0 }),
                                        a = r.obsoleteClass(((n && t.lastDaylight) || t.lastUpdate) / 1e3),
                                        s =
                                            L.latLng(t.location.lat, t.location.lon).distanceTo(e.currentLocation) /
                                            1e3,
                                        c =
                                            s > 0
                                                ? d.D_DISTANCE +
                                                  ' ' +
                                                  l.distance.convertValue.call(l.distance, 1e3 * s, ' ')
                                                : '';
                                    return (
                                        '<div class="webcam" data-do="webcam,' +
                                        i +
                                        '" data-webcam="' +
                                        i +
                                        '">\n                <div class="webcam-inner">\n                    <div class="webcam-image" style="background-image: url( img/ajax-loader.gif );"></div>\n                    <div class="webcam-description">\n                        <div class="wbcm-name noselect">' +
                                        t.title +
                                        '</div>\n                        ' +
                                        (e.singleLine
                                            ? '<small class="noselect fresh-title ' +
                                              a +
                                              '">' +
                                              o +
                                              ', ' +
                                              c +
                                              '</small>'
                                            : '<small class="noselect multilined fresh-title ' +
                                              a +
                                              '">' +
                                              o +
                                              '<br />' +
                                ...
                                .join('')),
                                this.useHover &&
                                    this.el.querySelectorAll('div[data-webcam]').forEach(function (t) {
                                        (t.onmouseover = e.addMarker.bind(e, +t.dataset.webcam)),
                                            (t.onmouseout = e.removeMarker.bind(e));
                                    });
                        }
                    },
                    forEach: function (e) {
                    ...
                    loadImages: function () {
                        ...
                        this.forEach(function (t, i) {
                            ...
                            (t.querySelector('.webcam-image').style.backgroundImage =
                                'url(' + o + '), url( img/ajax-loader.gif )'),
    ...
    W.define('BindedBar', ['store', 'Bar', 'format'], function (e, t, n, i) {
        var o = n.extend({
            ...
            _init: function () {
                n._init.call(this),
                    t.on('usedLang', this.render, this),
                    t.on('hourFormat', this.render, this),
                    t.on('zuluMode', this.render, this),
                    t.on(this.bindTimestamp, this.ontstamp, this),
                    t.on(this.bindCalendar, this.setCal, this),
                    (this.ondragstart = this.stopAnim),
                    this.setCal(t.get(this.bindCalendar)),
                    this.set(t.get(this.bindTimestamp));
            },
            render: function () {
                (this.zuluMode = t.get('zuluMode')),
                    this.text.removeAttribute('data-zulu'),
                    (this.displayHour = i.getHoursFunction()),
                    (this.text.textContent = this.createText(this.text));
            },
            ...
            onbcast: function () {
                t.set(this.bindTimestamp, this.timestamp, { UIident: this.UIident });
            },
            stopAnim: function () {
    ...
    W.define('Window', ['utils', 'trans'], function (e, t, n) {
        var i = n.translateDocument,
            ...
            r = function (e) {
                ...
                this.initProperties(),
                    (this.unmountOnClose = null !== (t = e.unmountOnClose) && void 0 !== t ? t : this.unmountOnClose),
                    (this.attachPoint = null !== (n = e.attachPoint) && void 0 !== n ? n : this.attachPoint),
                    (this.bodyClass = null !== (i = e.bodyClass) && void 0 !== i ? i : this.bodyClass),
                    (this.className = e.className),
                    (this.closeOnClick = null !== (o = e.closeOnClick) && void 0 !== o ? o : this.closeOnClick),
                    (this.displayBlock = null !== (r = e.displayBlock) && void 0 !== r ? r : this.displayBlock),
                    (this.html = e.html),
                    (this.domEl = null !== (a = e.domEl) && void 0 !== a ? a : this.domEl),
                    (this.htmlID = e.htmlID),
                    (this.ident = e.ident),
                    (this.keyboard = null !== (s = e.keyboard) && void 0 !== s ? s : this.keyboard),
                    (this.replaceMountingPoint =
                        null !== (l = e.replaceMountingPoint) && void 0 !== l ? l : this.replaceMountingPoint),
                    (this.timeout = null !== (c = e.timeout) && void 0 !== c ? c : this.timeout),
                    (this.onclose = null !== (d = e.onclose) && void 0 !== d ? d : this.onclose),
                    (this.onclosed = null !== (u = e.onclosed) && void 0 !== u ? u : this.onclosed),
                    (this.onopen = null !== (h = e.onopen) && void 0 !== h ? h : this.onopen);
            };
        (r.prototype.close = function (e) {
            ...
            this.isOpen &&
                ...
                Promise.resolve(this.onclose()).then(function () {
                    n.closingTimer = setTimeout(function () {
                        n.onclosed(), n.unmount();
                    }, 500);
                }),
                this.removeHooks(),
                !this.closeOnClick && (null == e ? void 0 : e.stopPropagation) && e.stopPropagation());
        }),
            (r.prototype.open = function () {
                var e = this;
                if (
                ...
                if ((this.mount(), !this.node))
                    throw new Error('Cannot open Window ' + this.ident + ', mount method does not set node property!');
                return (
            ...
            (r.prototype.initProperties = function () {
                (this.domEl = null),
                    ...
                    (this.keyboard = !1),
                    (this.closeOnClick = !1),
                    (this.replaceMountingPoint = !1),
                    (this.unmountOnClose = !0),
                    (this.displayBlock = !0),
                    (this.timeout = 0),
                    (this.isOpen = !1),
                    (this.bindedClose = this.close.bind(this)),
                    (this.bodyClass = 'on' + r.iAm + '-' + this.ident);
            }),
            (r.prototype.createNode = function () {
                var e = document.createElement('div');
                (e.id = this.htmlID || r.iAm + '-' + this.ident),
                    this.className && (e.className = this.className),
                    (e.innerHTML = this.html + '<div class="closing-x"></div>');
                var t = this.domEl || o(this.attachPoint);
                if (!t || (this.replaceMountingPoint && !t.parentElement))
                    throw new Error('Cannot create node for Window ' + this.ident + ', target element does not exist.');
                return (
                    this.replaceMountingPoint ? t.parentElement.replaceChild(e, t) : t.appendChild(e),
                    (o('.closing-x', e).onclick = this.bindedClose),
                    e
                );
            }),
                            ...
                            null !==
                                (t =
                                    null === (e = this.node) || void 0 === e
                                        ? void 0
                                        : e.querySelectorAll('[data-ref]')) && void 0 !== t
                                ? t
                                : [],
                        i = 0,
                        o = n.length;
    ...
    W.define('BindedDropDown', ['BindedSwitch', 'DropDown', 'store'], function (e, t, n, i) {
        var o = n.extend(t, {
            _init: function () {
                (this.initValue = i.get(this.bindStore)),
                    i.on(this.bindStore, this.set, this),
                    'function' == typeof this.render && i.on('usedLang', this.render, this),
                    n._init.call(this);
            },
            set: function (e) {
        ...
        var o = i.t,
            r = t.extend({
                ...
                createText: function (e) {
                    ...
                    if (this.zuluMode) {
                        var a =
                            this.calendar.start + 36e5 * (0.5 + (this.numberOfHours * this.left) / this.progressWidth);
                        e.dataset.zulu = n.hourUTC(a);
                    }
                    return (
                        '' +
                        r +
                        this.displayHour(Math.round((this.numberOfHours * this.left) / this.progressWidth) % 24)
                    );
                },
                ...
                _init: function () {
                    ...
                    if (n) {
                        ...
                        n.addEventListener('scroll', function () {
                            n.scrollTop > 20 && !i
                                ? (e.pluginEl.classList.add('show-header'), (i = !0))
                                : n.scrollTop < 21 && i && (e.pluginEl.classList.remove('show-header'), (i = !1));
                        }),
                ...
                ondrag: function (e, t, n) {
                    (this.transformedY = this.startY + t),
                        ...
                        Math.abs(this.throttledY - this.transformedY) > this.threshold &&
                            ((this.difference = this.transformedY - this.throttledY),
                            (this.throttledY = this.transformedY)),
                        n.preventDefault();
                },
                ondragend: function () {
                        ...
                        ? ((this.pluginEl.style.transition = ''),
                          ...
                          this.difference > 0
                              ? this.closeOnSwipeDown || this.pluginEl.classList.contains('open-half')
                                  ? n.emit('rqstClose', this.pluginName)
    ...
    W.define(
        ...
        function (e, t, n, i, o, r, a, s, l, c, d, u, h, p) {
            var f,
                m = n.t;
            u.instance({
                    ...
                    (this.el.innerHTML = e
                        .map(function (e) {
                            ...
                            return (
                                ...
                                e +
                                '">' +
                                r.template('h' === t[2] ? m.ACC_NEXT_HOURS : m.ACC_NEXT_DAYS, { num: t[1] }) +
                                '</div>'
                            );
                        })
                        .join('')),
                        this.set(i.get('acTime'));
                },
            }),
                h.instance({ el: (a.isMobile, r.$('#playpause')), bindStore: 'animation' }),
                a.isMobile,
                p.instance({ progressBar: r.$('#progress-bar'), offset: 45, borderOffset: 10, UIident: 'main' }),
                d.instance({
                    el: document.body,
                    click: function (e) {
                        switch (e) {
                ...
                c.instance({
                    ...
                    _init: function () {
                        (this.debouncedRedraw = r.debounce(this.render.bind(this), 50)),
                            i.on('usedLang', this.render, this),
                            i.on('level', this.debouncedRedraw),
                            i.on('overlay', this.debouncedRedraw),
                            i.on('product', this.debouncedRedraw),
                            s.on('radarProviderChanged', this.render, this),
                            this.render();
                    },
                    render: function () {
                        var e = i.get('overlay'),
                            ...
                            r = i.get('level'),
                            s = [];
                        n.hasMoreLevels && 'surface' !== r && s.push(a.levelsData[r][0].replace(/Pa/, '')),
                            !/ecmwf/.test(o.ident) && o.modelName && o.modelName.length && s.push(o.modelName);
                        var c =
                            '<span class="uiyellow"\n                ' +
                            ...
                            '</span>';
                        c != this.lastString &&
                            ((this.el.innerHTML = c), (this.el.dataset.icon = n.icon), (this.lastString = c));
                    },
                });
        }
    ),
    W.define(
        'calendarUI',
        ['utils', 'rootScope', 'trans', 'store', 'format', 'Scrollable', 'broadcast'],
        function (e, t, n, i, o, r, a, s) {
            var l = i.t;
            n.isMobile &&
                a.instance({
                    ...
                    _init: function () {
                        var e = this;
                        a._init.call(this),
                            o.on('timestamp', this.set, this),
                            o.on('hourFormat', this.render, this),
                            o.on('calendar', this.render, this),
                            o.on('usedLang', this.render, this),
                            o.on('zuluMode', this.render, this),
                            window.addEventListener('resize', setTimeout.bind(null, this.render.bind(this), 500)),
                            setInterval(this.render.bind(this), t.tsHour),
                            this.render(),
                            this.set(o.get('timestamp')),
                            s.on('detailClose', function () {
                                e.set(o.get('timestamp'));
                            });
                    },
                    render: function () {
                        (this.calendar = o.get('calendar')),
                            (this.zuluMode = o.get('zuluMode')),
                            (this.localeHours = r.getHoursFunction()),
                            (this.timestamp = 0);
                        var e = this.calendar;
                        if (e) {
                            for (
                                var n = e.days.filter(function (t) {
                                        return t.start < e.end;
                                    }),
                                    i = '12h' === o.get('hourFormat'),
                                    a = '<b></b>',
                                    s = '',
                                    c = 1;
                                c < 24;
                            ...
                            this.box.removeAttribute('data-zulu'),
                                this.set(p),
                                this.renderBox(),
                                (t.$('b', this.scrollEl).style.left =
                                    window.innerWidth / 2 + (Date.now() - e.start) / this.tsPx + 'px');
                        }
                    },
                    slideUp: function () {
                        this.scrolling ||
                            ...
                            document.body.classList.add('mobile-calendar-expanded')),
                    ...
                    renderBox: function () {
                        this.zuluMode && (this.box.dataset.zulu = r.hourUTC(this.timestamp)),
                    ...
                    onscrollend: function () {
                        ...
                        o.set('timestamp', e, { UIident: this.UIident }),
    ...
    W.define(
        'calendarUIdesktop',
        ['store', 'utils', 'trans', 'rootScope', 'ClickHandler', 'Resizable'],
        function (e, t, n, i, o, r, a) {
            var s = i.t,
                l = n.$;
            if (!o.isMobile) {
                ...
                r.instance(a, {
                    ...
                    _init: function () {
                        r._init.call(this),
                            a._init.call(this),
                            t.on('calendar', this.render, this),
                            t.on('usedLang', this.render, this),
                            (this.onresize = this.render.bind(this)),
                            (this.click = t.set.bind(t, 'timestamp')),
                            this.render();
                    },
                    render: function () {
                        ...
                        if (e) {
                            ...
                            for (var l = 0; l < o; l++) {
                                ...
                                s +=
                                    '<div data-do="' +
                                    Math.min(c.middayTs, i) +
                                    '"\n                    class="uiyellow' +
                                    (c.middayTs < i ? ' clickable' : ' disabled') +
                                    '"\n                    style="width: ' +
                                    a +
                                    '%;">' +
                                    n(c) +
    ...
    W.define('loadersUI', ['broadcast', 'utils'], function (e, t, n) {
        ...
        t.on('paramsChanged', function (e, t) {
            ...
            t.on('redrawFinished', r),
            t.on('loadingFailed', r),
            t.on('noConnection', r);
    }),
    W.define('timeAnimation', ['utils', 'store', 'products', 'broadcast'], function (e, t, n, i, o) {
        ...
        function w() {
            d = t.bound(d + (h ? -0.25 : 0.1), 0.8, 3);
            var e = n.get('timestamp') + u * d;
            e < a.calendar.end ? (n.set('timestamp', e), (r = setTimeout(w, 50))) : p();
        }
        function y() {
            var e;
            (a = i[n.get('product')]).animation
                ? ((c = !0),
                  (l = s = n.get('path')),
                  (d = 2),
                  (u =
                      50 *
                      ((e = a.calendar.timestamps)[1] - e[0] < 2 * t.tsHour ? a.animationSpeed1h : a.animationSpeed)),
                  n.on('visibility', f),
                  n.on('product', p),
                  n.on('overlay', v),
                  o.on('redrawFinished', m),
                  o.on('paramsChanged', g),
                  o.on('pluginOpened', p),
                  w(),
            ...
            e !== c &&
                (e
                    ...
                    : ((c = !1),
                      ...
                      n.off('product', p),
                      n.off('overlay', v),
                      o.off('redrawFinished', m),
                      o.off('paramsChanged', g),
                      o.off('pluginOpened', p)));
        });
    }),
    ...
    W.define('Renderer', ['plugins', 'Class'], function (e, t, n) {
        var i = n.extend({
            ...
            open: function (e) {
                ...
                return (
                    (this.loadingPromise = Promise.all(i)
                        .then(function () {
    ...
    W.define(
        'DataTiler',
        ['utils', 'map', 'dataLoader', 'renderUtils', 'Class', 'store'],
        function (e, t, n, i, o, r, a) {
            var s = i.dataLoader,
                l = n.map,
                c = r.extend({
                    ...
                    getTiles: function (e) {
                        ...
                        if (Math.floor(i) === i) {
                            ...
                            for (
                                ...
                                for (var f = c; f <= d; f++) {
                                    var m = this.wrapCoords({ x: f, y: p, z: i });
                                    s.push(m);
                                }
                            ...
                            s.forEach(function (t) {
                                var i,
                                    ...
                                    s =
                                        a &&
                                        (null === (r = (i = n).processTile) || void 0 === r ? void 0 : r.call(i, a, e));
                                if (s && !_[s.url]) {
                                    _[s.url] = 1;
                    ...
                    postProcess: function (e, t, n, i) {
                        if (e === this.syncCounter) {
                            ...
                            (this.trans = 0 | o.getTrans(t.zoom, t.dZoom)),
                            ...
                            a < 0 && (a = 256 + a),
                                ...
                                (this.offsetY = (s * this.trans) | 0),
                                (this.offset = 2056),
                                (this.width = t.width),
                                (this.height = t.height),
                                (this.w = o.getWTable(this.trans)),
                    ...
                    sortTiles: function (e, t, n) {
                        for (
                            var i,
                                ...
                                a = this,
                                s = function (n, i) {
                                    var r = a.wrapCoords({ x: n, y: i, z: e.zoom });
        ...
        var i = t.extend({
            ...
            getAmount: function (e) {
                var t = e.speed2pixel < 1 ? 1 + 1.5 * (1 - e.speed2pixel) : 1,
                    ...
                    i =
                        1 /
                        (this.multiplier.constant * Math.pow(n * this.multiplier.pow, e.zoom - this.multiplier.zoom));
    ...
    W.define(
        'TileLayerCanvas',
        ['rootScope', 'renderUtils', 'utils', 'dataLoader', 'renderTile'],
                ...
                c = L.GridLayer.extend({
                    ...
                    onRemove: function (e) {
                        return (
                            ...
                            n.emitter.emit('toggleSeaMask', this.hasSea),
                            (this.landOnly = !1),
                            document.body.classList.remove('land'),
                            n.emitter.emit('toggleLandMask', this.landOnly),
                            this
                        );
                    },
                    ...
                    paramsChanged: function (e) {
                        (e.fullPath === this.latestParams.fullPath && e.layer === this.latestParams.layer) ||
                            ((this.latestParams = i.clone(e)), this.syncCounter++, this.redrawLayer());
                    },
                    ...
                    redrawFinished: function () {
                        this.latestParams.sea !== this.hasSea &&
                            (i.toggleClass(document.body, this.latestParams.sea, 'sea'),
                            (this.hasSea = Boolean(this.latestParams.sea)),
                            n.emitter.emit('toggleSeaMask', this.hasSea)),
                            this.latestParams.landOnly !== this.landOnly &&
                                (i.toggleClass(document.body, this.latestParams.landOnly, 'land'),
                                (this.landOnly = this.latestParams.landOnly),
                                n.emitter.emit('toggleLandMask', this.landOnly)),
                            n.emitter.emit('rendered', 'tileLayer');
                    },
    ...
    W.define('TileLayer', ['Renderer', 'map', 'tileLayer', 'tileInterpolator'], function (e, t, n, i, o) {
        var r = n.map,
            a = t.extend({
                onopen: function (e) {
                    r.hasLayer(i)
                        ? i.paramsChanged.call(i, e)
                        : (i.init(e), i.addTo(r), i.getContainer().classList.add('overlay-layer')),
                        W.require('@plugins/gl-tile-render');
                    try {
                ...
                onclose: function (e) {
                    e.includes('tileLayer') ||
                        e.includes('tileLayerPatternator') ||
                        e.includes('daySwitcher') ||
                        r.removeLayer.call(r, i);
                },
            });
        e.default = a;
    }),
    W.define('dataLoader', ['lruCache', 'rootScope', 'utils', 'broadcast'], function (e, t, n, i, o) {
            ...
            return (
                ...
                (this.promise = new Promise(function (t, n) {
                    ...
                    (r.crossOrigin = 'Anonymous'),
                        ...
                        (r.onerror = function () {
                            (e.status = 'failed'),
                                o.emit('loadingFailed', e.url),
                                ++a > s && (o.emit('noConnection'), (a = 0)),
                        ...
                        Promise.resolve()
                            ...
                            .then(function (t) {
                                (e.url = t.getApiUrl(e.url)),
                                    (r.src = e.url),
                                    (r.complete || void 0 === r.complete) && ((r.src = i.emptyGIF), (r.src = e.url));
                            });
                })),
                this.promise
            );
                ...
                loadTile: function (e) {
                    ...
                    switch (n.status) {
                        ...
                        case 'loading':
                            return n.promise;
                        case 'failed':
                            return u.remove(t), Promise.reject({ message: 'Failed to load tile', url: t });
                        default:
        ...
        var g = function () {
            ...
            w = function () {
                v
                    ? ((0, window.W.require)('http')
                          .post('https://api.windy.com/api4/refresh', { data: { token: v } })
                          .then(function (e) {
                              var t = e.data;
                              t.exceeded
                                  ? (console.error('Windy API exceeded its daily limit. Please upgrade your plan.'),
                                    g())
                                  : (v = t.auth);
                          })
                          .catch(function (e) {
                              401 === (null == e ? void 0 : e.status) &&
                                  (console.error('Failed to verify Windy API token: ' + e.response, e),
                                  (v = void 0),
                                  (h = function () {
                                      return '';
                                  }),
    ...
    W.define('renderUtils', ['Evented'], function (e, t) {
        ...
        (e.createCombinedFillFun = function (e, t, n, i) {
            ...
            return function (e, t, n, c) {
                ...
                if (!o || !r)
                    throw new Error(
                        'Cannot create combinedFillFun, col1 (' + o + ') or col2 (' + r + ') is not defined!'
                    );
                var p = ((t << 8) + e) << 2,
                    f = a(n),
                    m = s(c),
            ...
            (e.getWTable = function (e) {
                ...
                for (t = new Uint16Array(4 * e * e), i = 0; i < e; i++)
                    for (n = 0; n < e; n++)
                        (t[o++] = (e - i) * (e - n)), (t[o++] = (e - i) * n), (t[o++] = i * (e - n)), (t[o++] = n * i);
                return (l[e] = t), t;
            }),
            (e.imgData = h),
            (e.interpolateNearest = function (e, t, n, i, o, r, a, s, l, c) {
    ...
    W.define('renderers', ['Renderer', 'testWebGl', 'plugins', 'utils', 'TileLayer'], function (e, t, n, i, o, r) {
        var a = r.instance({ dependencies: ['gl-tile-render'] }),
            s = r.instance({
            ...
            l = t.instance({
                ...
                onopen: function () {
                    ...
                    (this.onopen = e.onopen),
                        ...
                        (this.redraw = e.redraw),
                        (this.interpolator = e.interpolator);
                },
            }),
            c = t.instance({
            ...
            f = {
                ...
                map: t.instance({
                    ...
                    onopen: function () {
                        ...
                        (this.onopen = e.onopen),
                            (this.onclose = e.onclose),
                            (this.redraw = o.emptyFun),
                            (this.paramsChanged = o.emptyFun),
                            (this.interpolator = e.interpolator);
                    },
                }),
    ...
    W.define(
        'renderCtrl',
        ['renderers', 'layers', 'overlays', 'broadcast', 'utils', 'renderUtils'],
        function (e, t, n, i, o, r, a) {
            var s = a.emitter,
                l = Object.keys(t),
                c = null,
            ...
            o.on('paramsChanged', function (e) {
                ...
                var a = o.map(function (t) {
                    var i = n[t];
                    return r.push(i.renderer), { renderer: i.renderer, params: i.getParams(e, e.product) };
                });
                    ...
                    var o = this,
                        a = function (t, r) {
                            ...
                            var w = v[g],
                                ...
                                I = f * f,
                                N = (w * O + y * R + E * x + A * D) / I,
                                W = i.interpolateNearestG
                                    ? n.interpolateNearest(null, 0, b, T, P, L, O, R, x, D)
                                    : (b * O + T * R + P * x + L * D) / I,
                                k = (S * O + _ * R + C * x + M * D) / I;
    ...
    W.define('renderTile', ['renderUtils', 'layers'], function (e, t, n) {
        var i = function (e, i, o, r, a) {
            ...
            var d,
                ...
                p = t.imgData.data;
            'png' === l.fileSuffix
                ? l.PNGtransparency && (d = t.testPNGtransparency)
                : l.JPGtransparency && (d = t.testJPGtransparency);
            var f,
                m,
                v,
                g,
                ...
                ae = ie;
            for (g = 0; g < 256; g += i)
                for (N = g - ((R = g >> b) << b), v = 0; v < 256; v += i)
                    (I = v - ((O = v >> b) << b)),
                        x !== O &&
                            ((L = (2056 + O + C + (((D = R + M) << 8) + D)) << 2),
                            void 0 !== d && (w = d(u, L)),
                            !0 === $ && (L += 2),
                            (k = u[L]),
                            (U = u[L + 4]),
                            (F = u[L + 1028]),
                            (H = u[L + 1032]),
                            !0 === K && ((G = u[L + 1]), (z = u[L + 5]), (B = u[L + 1029]), (j = u[L + 1033])),
                            (x = O)),
                        w
                            ? ae(v, g, NaN)
                            : ((Q = te(
                              ...
                              !0 === K &&
                                  (Z = ee(
                                      null !== A
                                          ? (G * A[P] + z * A[P + 1] + B * A[P + 2] + j * A[P + 3]) >> T
                                          : G * V + z * Y + B * q + j * X
                                  )),
                              c && re ? re(v, g, Q, Z) : ie(v, g, K ? Math.sqrt(Q * Q + Z * Z) : Q));
            h.putImageData(t.imgData, 0, 0),
                'pattern' in l &&
                    l.pattern &&
                    '@plugins/patternator' in W &&
                    W['@plugins/patternator'][l.pattern].addPattern(h, y, u, 2056, C, M, E, te, ee),
        ...
        (e.renderNoDataTile = function (e, t) {
            ...
            (i.fillStyle = '#888'),
                ...
                t
                    ...
                    : ((i.fillStyle = 'red'),
                      (i.font = '20px Arial'),
                      i.fillText(atob('VU5BVVRIT1JJWkVEIFVTRSBPRg=='), 0, 20),
                      i.fillText(atob('V2luZHkuY29tIEFQSQ=='), 0, 40),
                      (i.fillStyle = i.strokeStyle = '#BBB'));
        }),
            (e.renderTile = function (e, t, n, o, r) {
                var a = this;
                n === this.syncCounter &&
                    ('@plugins/gl-tile-render' in W
                        ? W['@plugins/gl-tile-render'].processTile(this, t, o, r).then(function (n) {
                              n || i(a, e, t, o, r);
                          })
                        : i(this, e, t, o, r));
            });
    ...
    W.define('GlObj', [], function (e) {
        ...
        (a.prototype.reset = function () {
            ...
            (a.prototype.create = function (e, t, n) {
                if (((this._name = n), !this._gl && !this.canvas))
                    return (
                        (this.canvas = e),
                        (this._gl = e.getContext('webgl', t) || e.getContext('experimental-webgl', t)),
                        this._gl
                    );
            }),
            ...
            (a.prototype.createShader = function (e, t, n) {
                ...
                if (
                    o &&
                    (this.keepRefsShaders && this.shaders.push(o),
                    i.shaderSource(o, e),
                    i.compileShader(o),
                    ...
                    throw (
                        ...
                        (a.name = n || 'shader'),
                        (a.full =
                            'ERROR compileShader! name: ' +
                            a.name +
                            '; (' +
                            (a.isVertexShader ? 'VS' : 'FS') +
                            '); (' +
                            (a.contextLost ? 'contextLost' : 'NOT contextLost') +
                            '); msg: ' +
                            a.message),
                        a)
                    );
            ...
            (a.prototype.createProgramObj = function (e, t, n, i) {
                ...
                if (
                    ...
                    throw (
                        (((l = new Error(f)).contextLost = a.isContextLost()),
                        (l.name = i || 'shader'),
                        (l.full =
                            'ERROR linkProgram! name: ' +
                            l.name +
                            '; (' +
                            (l.contextLost ? 'contextLost' : 'NOT contextLost') +
                            '); msg: ' +
                            l.message),
                        l)
                    );
            ...
            (a.prototype.bindAttribute = function (e, t, i, o, r, a, s) {
                var l = this.gl();
                l &&
                    (l.bindBuffer(n.ARRAY_BUFFER, e),
                    l.enableVertexAttribArray(t),
                    l.vertexAttribPointer(t, i, o, r, a, s));
            }),
            ...
            (a.prototype.createTexture2D = function (e, t, n, i, o, r, a, s) {
                ...
                if (l) {
                    ...
                    return (
                        ...
                        this.resizeTexture2D(c, i, o, r, a, s)
                    );
                }
                return null;
            }),
                    ...
                    if ((s.bindTexture(n.TEXTURE_2D, e), Array.isArray(t))) {
                        ...
                        for (var d = 0; d < t.length; d++) {
                            ...
                            null === u || ArrayBuffer.isView(u)
                                ? s.texImage2D(n.TEXTURE_2D, d, r, l, c, 0, r, n.UNSIGNED_BYTE, u)
                                : s.texImage2D(n.TEXTURE_2D, d, r, r, n.UNSIGNED_BYTE, u),
                                (l = Math.max(l >> 1, 1)),
                                (c = Math.max(c >> 1, 1));
                        }
                        a = !1;
                        ...
                        null === t || ArrayBuffer.isView(t)
                            ? s.texImage2D(n.TEXTURE_2D, 0, r, i, o, 0, r, n.UNSIGNED_BYTE, t)
                            : s.texImage2D(n.TEXTURE_2D, 0, r, r, n.UNSIGNED_BYTE, t);
            ...
            (a.prototype.setBindedTexture2DParams = function (e, t, i, o) {
                var r = this.gl();
                r &&
                    (r.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, e),
                    r.texParameteri(n.TEXTURE_2D, n.TEXTURE_MAG_FILTER, t),
                    r.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, i),
                    r.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, o || i));
            }),
            (a.prototype.createBuffer = function (e) {
                var t = this.gl(),
                    n = null;
                return (
                    t && (n = t.createBuffer()) && (this.keepRefs && this.buffers.push(n), this.setBufferData(n, e)), n
                );
            }),
            ...
            (a.prototype.createIndexBuffer = function (e) {
                ...
                return (
                    t &&
                        ((i = t.createBuffer()),
                        this.keepRefs && i && this.buffers.push(i),
                        t.bindBuffer(n.ELEMENT_ARRAY_BUFFER, i),
                        t.bufferData(n.ELEMENT_ARRAY_BUFFER, e, n.STATIC_DRAW)),
                    i
                );
            }),
            ...
            (a.prototype.deleteFramebuffer = function (e) {
                var t;
                a.removeFromArray(e, this.framebuffers),
                    null === (t = this.gl()) || void 0 === t || t.deleteFramebuffer(e);
            }),
            (a.prototype.bindFramebuffer = function (e, t) {
                var i = this.gl();
                i &&
                    (i.bindFramebuffer(n.FRAMEBUFFER, e),
                    t && i.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, t, 0));
            }),
        ...
        var r = WebGLRenderingContext,
            a = {
                ...
                useGLparticlesInner: function () {
                    var e = this,
                        ...
                        s = function () {
                            ...
                            return i.put('webGLtest3', { status: t, ua: a }), t === e.retOk;
                        };
                    return (
                        'desktop' === o.platform &&
                        'embed2' !== W.target &&
                        !t &&
                        (r && r.ua === a ? r.status === this.retOk : s())
                    );
                },
                ...
                runParticlesUpdateTest: function () {
                    var e = 0;
                    try {
                        this.initParticleUpdateTest() &&
                            ((this.status = this.startParticleUpdateTest()), (e = this.status === this.retOk ? 2 : 1));
                    } catch (e) {
                ...
                compileShader: function (e, t, n, i, o) {
                    ...
                    try {
                        ...
                        0, window.wError(o, e.full, e), this.shaderErrors++, (r = null);
                    }
                    return r;
                },
                startParticleUpdateTest: function () {
                    return (
                        this.renderParticleUpdateTest(1 / 255.5, 255, 0.125 / 255, -1 / 255),
                        this.compareDataFast(this.it.data0, this.it.data1) > 1e3 ? 'no-particles-update' : this.retOk
                    );
                },
                initWebGl: function () {
                    var e = null;
                ...
                initParticleUpdateTest: function () {
                    ...
                    if (
                        ((this.shaderErrors = 0),
                        (this.it.shEncodeDecode = this.compileShader(
                            this.shRectVS,
                            this.shEncodeDecodeFS,
                            void 0,
                            'EncodeDecode',
                            'glParticlesTest'
                        )),
                        ...
                        return (this.status = 'error-shader-compilation'), !1;
                    ...
                    for (n = 0; n < this.it.h; n++)
                        for (t = 0; t < this.it.w; t++)
                            (this.it.data0[i++] = t + t),
                                (this.it.data0[i++] = t + t + 1),
                                (this.it.data0[i++] = n),
                                (this.it.data0[i++] = n);
                    return (
                        (this.it.texture0 = e.createTexture2D(
                            r.NEAREST,
                            r.NEAREST,
                            r.REPEAT,
                            this.it.data0,
                        ...
                        (this.it.texture1 = e.createTexture2D(
                            r.NEAREST,
                            r.NEAREST,
                            r.REPEAT,
                            this.it.data1,
                ...
                renderParticleUpdateTest: function (e, t, n, i) {
                    ...
                    if ((o.bindFramebuffer(this.it.framebuffer, this.it.texture1), a)) {
                        ...
                        a.useProgram(s.program),
                            o.bindAttribute(this.it.vertexBufferRect, s.aPos, 2, r.FLOAT, !1, 8, 0),
                            o.bindTexture2D(this.it.texture0, 0, s.sTex0),
                            a.uniform4f(s.uPars, e, t, n, i),
                            a.drawArrays(r.TRIANGLE_FAN, 0, 4),
                            a.readPixels(0, 0, this.it.w, this.it.h, r.RGBA, r.UNSIGNED_BYTE, this.it.data1);
                    }
    ...
    W.define('ImageGraph', ['ImageMaker'], function (e, t) {
        var n = (function (e) {
            ...
            return (
                ...
                (t.prototype = Object.create(e && e.prototype)),
                (t.prototype.constructor = t),
                (t.prototype.getY = function (e, t, n, i) {
                    return (i * (n - e)) / (n - t);
                }),
                (t.prototype.getControlPoint = function (e, t, n) {
                    var i = 0;
                    return (
                        (n[1] <= t[1] && e[1] <= t[1]) || (n[1] >= t[1] && e[1] >= t[1]) || (i = n[1] - e[1]),
                        [0.2 * (n[0] - e[0]) + t[0], 0.2 * i + t[1]]
                    );
                }),
                (t.prototype.createGradient = function (e, t, n) {
                    for (
                        var i,
                            o,
                            r = this.fillColors.length,
                            a = this.fillColors[0][0],
                            s = this.fillColors[r - 1][0],
                            l = 1 / (s - a),
                            c = this.h / (e - t),
                            d = c * (s - t),
                            u = c * (a - t),
                            h = this.ctx.createLinearGradient(0, u, 0, d),
                            p = 0;
                        p < r;
                        ++p
                    )
                        (o = this.fillColors[p][1]),
                            (i = l * (this.fillColors[p][0] - a)),
                            h.addColorStop(i, 'rgba( ' + o[0] + ', ' + o[1] + ', ' + o[2] + ', ' + n + ' )');
                    return h;
                }),
                ...
                (t.prototype.whiteBottom = function (e, t) {
                    ...
                    t < 1 && (e.globalCompositeOperation = 'destination-out'),
                        ...
                        (e.fillStyle = i),
                        e.fillRect(0, n, this.w, 0.5 * this.h);
                }),
                t
            );
        })(t.ImageMaker);
    ...
    W.define('ImageMaker', [], function (e) {
        var t = function e(t, n, i, o) {
            ...
            if (((this.canvasRatio = Math.min(window.devicePixelRatio || 1, 2)), r))
                (this.num = t.num),
        ...
        (t.prototype.getPixelRatioAdjustedSize = function (e) {
            ...
            (t.prototype.resetCanvas = function () {
                return (
                    this.ctx.setTransform(1, 0, 0, 1, 0, 0), this.ctx.scale(this.canvasRatio, this.canvasRatio), this
                );
            }),
                ...
                return (
                    ...
                    (t.prototype.render = function (e, t) {
                        ...
                        var n,
                            ...
                            f = h[1];
                        for (i = 0; i < a + 4; ++i)
                            (n = o[Math.max(0, Math.min(i - 2, a - 1))]),
                                d.push([u, this.getY(n, p, f, c), n]),
                                (u += s);
                        for (i = 0; i < a; ++i)
                            d[i + 2][1] =
                                0.6 * d[i + 2][1] + 0.15 * (d[i + 1][1] + d[i + 3][1]) + 0.05 * (d[i][1] + d[i + 4][1]);
                        ...
                        return (
                            r.lineTo(d[a + 2][0], c),
                            this.fillColors
                                ? ((r.fillStyle = this.createGradient(p, f, t)), r.fill())
                                : ((r.lineWidth = this.lineWidth), (r.strokeStyle = this.strokeStyle), r.stroke()),
                            this.bottomWhitten && this.whiteBottom(r, t),
                            this
                        );
                    }),
                    t
            ...
            s = (function (e) {
                ...
                return (
                    ...
                    (t.prototype.findMinMax = function (e) {
                        ...
                        t -= 1;
                        var i = (n = (t -= Math.round(0.05 * (n - t))) + Math.round(n - t)) - t;
                        return (
                            i < 10 &&
                                ((i = Math.round(0.5 * (10 - i))),
                                (t -= Math.round(0.5 * i)),
                                (n += Math.round(1.5 * i))),
                            [t, n]
                        );
                    ...
                    (t.prototype.render = function (e) {
                        for (var t = e.isDay, n = 0; n < t.length; n++) {
                            ...
                            (this.ctx.fillStyle = this.nightColor),
                                1 === i
                                    ? this.ctx.clearRect(o, 0, r, this.h)
                                    : 0 === i
                                    ? this.ctx.fillRect(o, 0, r, this.h)
                                    : i < 0
                                    ? (this.ctx.clearRect(o, 0, a, this.h), this.ctx.fillRect(a, 0, r, this.h))
                                    : (this.ctx.fillRect(o, 0, a, this.h), this.ctx.clearRect(a, 0, r, this.h));
                        }
                        return this;
                    }),
                    t
        ...
        var o = i.extend({
            ...
            key: function (e) {
                return 'string' == typeof e
                    ...
                    : 'webcam' === e.type
                    ? String(e.webcamId)
                    : ('airport' === e.type && e.icao) || e.icao
                    ? e.icao
                    : n.normalizeLatLon(e.lat) + '/' + n.normalizeLatLon(e.lon);
            },
                ...
                if ('object' == typeof e) {
                    ...
                    if (n.isValidLatLonObj(e)) {
                        return (
                            t(function (t) {
                                return (
                                    n.normalizeLatLon(e.lat) == n.normalizeLatLon(t.lat) &&
                                    n.normalizeLatLon(e.lon) == n.normalizeLatLon(t.lon)
                                );
                            }) ||
                            t(function (t) {
            ...
            load: function () {
                (this.data = t.get(this.ident) || {}),
                    n.each(this.data, function (e, t) {
            ...
            sortFavs: function (e, t, n) {
                ...
                return (
                    ...
                    (i = i.sort(function (e, n) {
                        return (
                            (null !== (o = a[n][t]) && void 0 !== o ? o : 0) -
                            (null !== (r = a[e][t]) && void 0 !== r ? r : 0)
                        );
                    }))
                );
            },
                ...
                for (
                    var r,
                        ...
                        l = o
                            ...
                            : null,
                        c = this.sortFavs(t, i, l),
                        d = 0;
                    d < Math.min(e, c.length);
                    d++
                )
                    (a = c[d]), (r = n.clone(this.data[a])), (s[d] = r);
                return s;
            },
        });
        e.default = o;
    ...
    W.define(
        'LabelsLayer',
        ['products', 'http', 'urls', 'rootScope', 'utils', 'overlays', 'store', 'broadcast', 'singleclick'],
        function (e, t, n, i, o, r, a, s, l, c) {
            var d = L.GridLayer.extend({
                ...
                onAdd: function () {
                    return (
                        this.hasHooks ||
                            (this.updateProduct(),
                            this.createTilesUrl(),
                            c.on('poi-label', this.onClick, this),
                            s.on('timestamp', this.onTsChange, this),
                            s.on('usedLang', this.updateLabels, this),
                            s.on('englishLabels', this.updateLabels, this),
                            s.on('product', this.updateProduct.bind(this, !0)),
                            l.on('metricChanged', this.refreshWeather, this),
                            (this.hasHooks = !0)),
                        L.GridLayer.prototype.onAdd.call(this)
                    );
                },
                ...
                onClick: function (e, t) {
                    ...
                    if (n) {
                        var o = n.split('/'),
                            r = o[0],
                            a = o[1];
                        l.emit('rqstOpen', 'detail', { lat: +r, lon: +a, name: i, source: 'label' });
                    }
                },
                ...
                createTile: function (e, t) {
                    ...
                    return (
                        ...
                        n
                            .get(this.tilesUrl + '/' + o + '.json', { cache: !1 })
                            .then(function (t) {
                ...
                renderTile: function (e, t, n) {
                    for (
                        ...
                        (A.textContent = A.dataset.label = m),
                            ...
                            (A.dataset.poi = 'label'),
                            (A.className = v),
                            (A.style.transform = 'translate(' + _ + 'px, ' + E + 'px)'),
                            (A.style.width = y + 'px'),
                            T || u.push({ id: S, el: A }),
                            e.appendChild(A);
                    }
                ...
                getIndexToCityTileData: function () {
                    var e,
                        ...
                        i = s.get('product'),
                        o =
                            null === (e = t[i]) || void 0 === e || null === (n = e.calendar) || void 0 === n
                                ? void 0
                                : n.timestamps;
                    if (!o) return null;
                ...
                renderWeather: function (e) {
                    ...
                    if (t)
                        if (n && n.length) {
                            ...
                            i && i >= 0 && i < n.length
                                ? (t.dataset.temp = a.temp.convertNumber.call(a.temp.m, n[i]) + 'Â°')
                                : t.removeAttribute('data-temp');
        ...
        function (e, t, n, i, o, r, a, s, l, c, d) {
            ...
            var p = 0,
                ...
                m =
                    c.sharedCoords ||
                    ('location' === f
                        ? a.get('homeLocation') || { lat: 50, lon: 14 }
                        : 'last' === f
                        ? a.get('startUpLastPosition')
                        : l.getMyLatestPos()),
            ...
            function T(e, t) {
                ...
                if (e.paddingLeft || e.paddingTop) {
                    var i = e.paddingLeft || 0,
                        ...
                        s = w.unproject(a, n);
                    w.setView(s, n, { animate: t });
                } else w.setView([e.lat, e.lon], n, { animate: t });
            }
            'source' in m &&
                'fallback' === m.source &&
                s.once('newLocation', function (e) {
                    (e.zoom = 5), T(e, !0);
                });
            var S,
                _,
            ...
            function P(e) {
                e &&
                    !A &&
                    n.graticule.load.call(n.graticule).then(function () {
            ...
            function C() {
                ...
                a.set('mapCoords', { source: 'maps', lat: e.lat, lon: e.wrap().lng, zoom: t }),
            ...
            function M() {
                ...
                var s,
                    l = {
                        ...
                        sat:
                            'https://{s}.aerial.maps.api.here.com/maptile/2.1/maptile/newest/satellite.day/{z}/{x}/{y}/256/jpg?' +
                            o.hereMapsID,
                    },
                    c = a.get('map'),
                    d = 'basemap-layer',
                ...
                (s =
                    'sat' === c
                        ? { 13: { url: l.satLocal }, 18: { url: l.sat, subdomains: '1234' } }
                        : { 18: { url: l[c] || l.sznmap } }),
                    ('map' !== u || v) &&
                        (r
                            ? ((s[11] = { url: l.graymap, patchUrl: l.graymapPatch11, patch: r }),
                              'satellite' === u
                                  ? ((s[5] = { url: l.simplemapPatch5 }),
                                    (s[9] = { url: l.simplemap, patchUrl: l.simplemapPatch9, patch: r }))
                                  : (s[5] = { url: l.graymapPatch5 }))
                            : ((s[11] = { url: l.graymap }), 'satellite' === u && (s[9] = { url: l.simplemap }))),
                    S && w.removeLayer(S),
                    (S = L.tileLayer(l.graymap, {
                        detectRetina: !1,
                        minZoom: 3,
                        maxZoom: 11,
            ...
            C(),
                ...
                P(a.get('graticule')),
                w.on('moveend', C),
                w.on('movestart', function () {
                    s.emit('movestart');
                }),
                s.on('maps-zoomIn', w.zoomIn, w),
                s.on('maps-zoomOut', w.zoomOut, w),
                s.on('updateBasemap', M),
                a.on('map', M),
                a.on('graticule', P),
                u.on('toggleSeaMask', function (e) {
                    e && !_
                        ? (_ = L.tileLayer(o.tileServer + '/tiles/v9.0/grayland/{z}/{x}/{y}.png', {
                              minZoom: 3,
                              maxZoom: 11,
                              updateWhenIdle: !!o.isMobileOrTablet,
                              updateWhenZooming: !1,
                ...
                u.on('toggleLandMask', function (e) {
                    ...
                    e && !E
                        ? null ===
                              (t =
                                  null ==
                                  (E = new d(o.tileServer + '/tiles/v9.0/grayland/{z}/{x}/{y}.png', {
                                      minZoom: 3,
                                      maxZoom: 11,
                                      updateWhenIdle: !!o.isMobileOrTablet,
                                      updateWhenZooming: !1,
                        ...
                        : !e && E && (w.removeLayer(E), (E = null));
                }),
                a.on('usedLang', O),
                a.on('country', O),
                (e.baseLayer = S),
                (e.centerMap = T),
                (e.ensurePointVisibleX = function (e, t, n) {
                ...
                (e.map = w),
                (e.markers = h),
                (e.removeZoomCenter = function () {
                    w._zoomCenter = void 0;
                }),
                (e.seaLayer = _),
                (e.setZoomCenter = function (e, t) {
    ...
    W.define('mapGlobeCtrl', ['broadcast', 'store'], function (e, t, n) {
        ...
        n.on('globeActive', function (e) {
            ...
            t.on('zoomIn', o.bind(null, 'zoomIn')),
            t.on('zoomOut', o.bind(null, 'zoomOut')),
            t.on('paramsChanged', o.bind(null, 'paramsChanged'));
    }),
    W.define('picker', ['Evented'], function (e, t) {
        var n = t.instance({ ident: 'picker' });
        e.default = n;
    }),
    W.define(
        'singleclick',
        ['map', 'Evented', 'rootScope', 'store', 'broadcast', 'plugins'],
        function (e, t, n, i, o, r, a) {
            var s = i.isMobile,
                l = t.map,
                c = n.instance({
                    ...
                    _init: function () {
                        n._init.call(this),
                            l.on('singleclick', this.opener, this),
                            s && o.on('hpShown', this.hpShown, this);
                    },
                    hpShown: function (e) {
                        var t = this;
                        e ||
    ...
    W.define('langEn', [], function (e) {
        e.default = {
            ...
            ALERT_NOTIFICATIONS:
                'Windy Alerts can be now sent directly to your mobile devices. Visit Settings for managing notification preferences.',
            DIRECTION_N: 'N',
            DIRECTION_NE: 'NE',
            DIRECTION_E: 'E',
            DIRECTION_SE: 'SE',
    ...
    (function () {
        ...
        var e = function (e) {
                var t;
                (null === (t = window.W.lib) || void 0 === t ? void 0 : t.verbose) &&
                    console.log('Initializing Windy API: ' + e);
            },
            t = function (e) {
                throw new Error('Windy API error: ' + e);
            };
        e('Checking Leaflet library'),
            window.L || t('Leaflet is missing. Add Leaflet to the HTML head tag.'),
            /^1\.4/.test(window.L.version) || t('Wrong version of Leaflet library. Version 1.4.x is required');
        var n,
            i = function (n, o) {
                var r;
                if (null === (r = window.W.lib) || void 0 === r ? void 0 : r.initialized) {
                    ...
                    return (
                        ...
                        void console.log(
                            '%c !!! Repeatedly calling "windyInit" of an already initialized API is an unsupported functionality and will be removed in future versions!',
                ...
                l('http')
                    .post('https://api.windy.com/api/map-forecast/v2/auth', {
                        data: { key: n.key, hostname: document.location.hostname },
                    })
                    .then(function (i) {
                        var r,
                            a,
                        ...
                        window.W.lib = {
                            verbose: n.verbose || !1,
                            initialized:
                                null !== (a = null === (r = window.W.lib) || void 0 === r ? void 0 : r.initialized) &&
                                void 0 !== a &&
                                a,
                            get initAuth() {
                                return s.auth;
                        ...
                        var h = d('#windy');
                        if (!h)
                            throw new Error('Windy API error: Missing <div id="windy"></div> in the BODY of the page');
                        (h.innerHTML = c.replace('__APIUSER__', s.apiUser)),
                            h.classList.add(s.paid ? 'paid-model' : 'free-model'),
                            document.body.classList.add('target-lib'),
                            e('Adding start-up options'),
                            (function (t, n, i) {
                                var o,
                                    r = t('rootScope'),
                                ...
                                if (
                                    ((n.expertMode =
                                        null !== (o = null == n ? void 0 : n.expertMode) && void 0 !== o && o),
                                    i.paid)
                                ) {
                                    var l, c;
                                    e('key type: paid');
                                    ...
                                    (null === (l = i.features) || void 0 === l ? void 0 : l.intersucho)
                                        ? e('intersucho is enabled')
                                        : u.push(
                                              'awr_0_40',
                                              'awr_0_100',
                                              'awp_0_40',
                                        ...
                                        (null === (c = i.features) || void 0 === c ? void 0 : c.ecmwf)
                                            ? e('ECMWF is enabled')
                                            : (u.push(
                                                  'ecmwf',
                                                  'ecmwfWaves',
                                              ...
                                              s.setDefault(
                                                  'product',
                                                  null !== (d = n.product) && void 0 !== d ? d : 'gfs'
                                              ),
                                              s.setDefault('prefferedProduct', 'icon' === n.product ? 'icon' : 'gfs'),
                                              (r.isolines = ['off', 'pressure', 'gh', 'temp'])),
                                        (r.overlays = h(r.overlays, u)),
                                        (r.localProducts = h(r.localProducts, u)),
                                        (r.globalProducts = h(r.globalProducts, u)),
                                        (r.seaProducts = h(r.seaProducts, u));
                                } else
                                    e('key type: basic user'),
                                        (r.localProducts = []),
                                        (r.globalProducts = ['gfs']),
                                        (r.overlays = ['wind', 'temp', 'pressure']),
                                        (r.isolines = ['off', 'pressure', 'gh', 'temp']),
                                        (r.seaProducts = []),
                                        s.setDefault('product', 'gfs'),
                                        s.setDefault('prefferedProduct', 'gfs'),
                                        s.setDefault('availProducts', ['gfs']),
                                        s.setDefault('visibleProducts', ['gfs']);
                                (r.products = r.globalProducts.concat(r.localProducts)),
                                    (a.product.allowed = r.globalProducts.concat(r.localProducts)),
                                    (a.overlay.allowed = [].concat(r.overlays)),
                                    (a.isolines.allowed = [].concat(r.isolines)),
                                    (a.prefferedProduct.allowed = []
                                        .concat(a.prefferedProduct.allowed)
                                        .filter(function (e) {
                                            return r.products.includes(e);
                                        })),
                                    n.favOverlays || (n.favOverlays = [].concat(r.overlays)),
                                    (a.favOverlays.def = n.favOverlays),
                                    e('Available products: ' + r.products.join(', ')),
                                    e('Available overlays: ' + r.overlays.join(', ')),
                                    (null == n ? void 0 : n.lat) &&
                                        ((null == n ? void 0 : n.lon) || (null == n ? void 0 : n.lng)) &&
                                        (s.set('startUp', 'location'),
                                        s.set('homeLocation', {
                                            lat: n.lat,
                                            lon: n.lon || n.lng || 0,
                            ...
                            setTimeout(function () {
                                try {
                                    u.translateDocument(h),
                                        e('Initializing rest of Windy API'),
                                        (function (n, i, o, r) {
                                            var a,
                                                s = n('picker'),
                                                l = n('store'),
                                            ...
                                            var g,
                                                w,
                                                y = null !== (a = i.overlay) && void 0 !== a ? a : l.get('overlay'),
                                            ...
                                            if (b !== T) {
                                                if (i.product)
                                                    return t(
                                                        'Product "' +
                                                            i.product +
                                                            '" set in options does not have an overlay "' +
                                                            y +
                                                            '".' +
                                                            (T ? ' Use "' + T + '" instead.' : '')
                                                    );
                                            ...
                                            l
                                                .set('product', i.product || l.get('product'), { forceChange: !0 })
                                                .then(function () {
                                                    return l.set(
                                                        'overlay',
                                                        null !== (w = i.overlay) && void 0 !== w ? w : 'wind',
                                                        { forceChange: !0 }
                                                    );
                                                })
                                                .then(function () {
                                                ...
                                                v(c.version + '/' + r.apiUser + '-' + r.id + '/' + r.name),
                                                e('Done. Calling your windyInit callback'),
                                                setTimeout(function () {
                                                    console.log(
                                                        '%c ðŸ„ Welcome to Windy JavaScript API. Please do not remove or conceal the Windy logo or the advertisement. The logo and the advertisement must remain a clickable link, and must lead to its target URL. Please see https://api.windy.com/ for documentation and for more information.',
                                                        'color: #9D0300; font-size: large'
                                                    ),
                                                        (window.W.lib.initialized = !0);
                                                }, 200);
                                        })(l, n, o, s);
                                } catch (e) {
                    ...
                    .catch(function (e) {
                        var t, n;
                        console.error('Failed to authorize Windy API key:', e),
                            (t = e.response && e.response.length > 0 ? e.response : 'Cannot connect to Windy'),
                            (n = function () {
                                document.getElementById('windy').innerHTML =
                                    '<div style="height:100%;display:flex;align-items:center;justify-content:center;background-image:url(https://www.windy.com/img/api/api-error-bgr.jpg);background-size: cover;background-position: center top;">\n<p style="background:#9d0300;border-radius:1em;padding:1em;line-height:1.5">\nNot authorized to <a style="color: inherit" href="https://api.windy.com/" target="_blank">Windy API</a>: ' +
                                    t +
        ...
        ((n = document.createElement('link')).rel = 'stylesheet'),
            ...
            (window.windyInit = function (e, t) {
                'loading' !== document.readyState
                    ? i(e, t)
                    : document.addEventListener('DOMContentLoaded', i.bind(null, e, t));
            });
    })();
